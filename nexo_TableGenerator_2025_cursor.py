...
def generate_table_row(level: int, element_info: dict, mult_info: dict,
    ...
    #special ugly workaround for VERY LONG components names, and LibreOffice not being able to split words resulting incomperrssible tablestable width
