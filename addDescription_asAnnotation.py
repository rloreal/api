...
if __name__ == '__main__':
    ...
    shortnamesDir = "C:/Users/romai/OneDrive/Documents/NEXO/api/casp_V6/json_from_xsd2json/"
    ...
    for f in os.listdir(shortnamesDir):
        ...
        if f.endswith('json') and not f.startswith('desc'):
                    ...
                    for j in json_schema_dict[i]:
                        if not (j.endswith("CodeDEF")):
                            if j in description:
                                ...
                                json_schema_dict[i][j]["description"] = description[j]
                                nbdesc += 1
                            else:
            ...
            with open(shortnamesDir+"desc_"+f, "w+") as result_file:
