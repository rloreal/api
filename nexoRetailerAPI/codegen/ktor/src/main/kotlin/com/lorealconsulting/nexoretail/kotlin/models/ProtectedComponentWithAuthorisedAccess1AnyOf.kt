...
import com.lorealconsulting.nexoretail.kotlin.models.AuthenticatedData1
import com.lorealconsulting.nexoretail.kotlin.models.DigestedData1
import com.lorealconsulting.nexoretail.kotlin.models.EnvelopedData3
import com.lorealconsulting.nexoretail.kotlin.models.SignedData1

import kotlinx.serialization.Serializable
/**
 * Protection of Identification of components which are allowed to access this cryptographic key. ProtectedComponentWithAuthorisedAccess
 ...
 */
@Serializable
data class ProtectedComponentWithAuthorisedAccess1AnyOf(
    /* Type of data protection. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).   */
    val cnttTp: ProtectedComponentWithAuthorisedAccess1AnyOf.CnttTp,
    /*  */
    val atId: kotlin.String? = null,
    val authntcdData: AuthenticatedData1? = null,
    val dgstdData: DigestedData1? = null,
    val envlpdData: EnvelopedData3? = null,
    val sgndData: SignedData1? = null
)
{
    /**
    * Type of data protection. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).  
