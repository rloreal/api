...
/**
 * Identification of the currency conversion operation for the service provider. CurrencyConversionIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class CurrencyConversionIdentification1(
