...
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalVehicleData1
import com.lorealconsulting.nexoretail.kotlin.models.DriverOrVehicleCard1
import com.lorealconsulting.nexoretail.kotlin.models.MaintenanceIdentification1
import com.lorealconsulting.nexoretail.kotlin.models.ReferHours1
import com.lorealconsulting.nexoretail.kotlin.models.TrailerHours1
import com.lorealconsulting.nexoretail.kotlin.models.TrailerNumber1
import com.lorealconsulting.nexoretail.kotlin.models.UnitNumber1
import com.lorealconsulting.nexoretail.kotlin.models.VehicleNumber1
import com.lorealconsulting.nexoretail.kotlin.models.VehicleTag1

import kotlinx.serialization.Serializable
/**
 * Information related to the vehicle used for the transaction. Vehicle
 * @param atId 
 * @param addtlVhclData 
 * @param drvrOrVhclCard 
 * @param hbmtr Hubometer reading value indicating the distance travelled by the trailer. Hubometer
 * @param mntncId 
 * @param odmtr Odometer reading value indicating the distance travelled by the vehicle. Odometer
 * @param refrHrs 
 * @param rplcmntCar True if the car is a replacement car. ReplacementCar
 * @param trlrHrs 
 * @param trlrNb 
 * @param unitNb 
 * @param vhclNb 
 * @param vhclTag 
 * @param vhclTagNtryMd Entry mode of the registration tag. VehicleTagEntryMode\\n\\n- ***TAGC*** : **Tag** Definition: Tag reading capabilities (RFID, etc.).  \\n\\n- ***PHYS*** : **Physical** Definition: Keyboard entry or OCR reading of embossing or printed data, either at time of transaction or after the event.  \\n\\n- ***BRCD*** : **BarCode** Definition: Bar code.  \\n\\n- ***MGST*** : **MagneticStripe** Definition: Magnetic stripe.  \\n\\n- ***CICC*** : **ICC** Definition: ICC (Integrated Circuit Card) with contact containing software applications conform to ISO 7816.  \\n\\n- ***DFLE*** : **AccountData** Definition: Account data on file.  \\n\\n- ***CTLS*** : **ProximityReader** Definition: Contactless proximity reader.  \\n\\n- ***ECTL*** : **EMVProximityReader** Definition: Contactless proximity reader, with application conform to the standard EMV (standard initiated by Europay, Mastercard and Visa).  \\n\\n- ***CDFL*** : **CardOnFile** Definition: Card information are stored on a file.  
 */
@Serializable
data class Vehicle1(
    /*  */
    val atId: kotlin.String? = null,
    val addtlVhclData: AdditionalVehicleData1? = null,
    val drvrOrVhclCard: DriverOrVehicleCard1? = null,
    /* Hubometer reading value indicating the distance travelled by the trailer. Hubometer */
    val hbmtr: java.math.BigDecimal? = null,
    val mntncId: MaintenanceIdentification1? = null,
    /* Odometer reading value indicating the distance travelled by the vehicle. Odometer */
    val odmtr: java.math.BigDecimal? = null,
    val refrHrs: ReferHours1? = null,
    /* True if the car is a replacement car. ReplacementCar */
    val rplcmntCar: kotlin.Boolean? = null,
    val trlrHrs: TrailerHours1? = null,
    val trlrNb: TrailerNumber1? = null,
    val unitNb: UnitNumber1? = null,
    val vhclNb: VehicleNumber1? = null,
    val vhclTag: VehicleTag1? = null,
    /* Entry mode of the registration tag. VehicleTagEntryMode\\n\\n- ***TAGC*** : **Tag** Definition: Tag reading capabilities (RFID, etc.).  \\n\\n- ***PHYS*** : **Physical** Definition: Keyboard entry or OCR reading of embossing or printed data, either at time of transaction or after the event.  \\n\\n- ***BRCD*** : **BarCode** Definition: Bar code.  \\n\\n- ***MGST*** : **MagneticStripe** Definition: Magnetic stripe.  \\n\\n- ***CICC*** : **ICC** Definition: ICC (Integrated Circuit Card) with contact containing software applications conform to ISO 7816.  \\n\\n- ***DFLE*** : **AccountData** Definition: Account data on file.  \\n\\n- ***CTLS*** : **ProximityReader** Definition: Contactless proximity reader.  \\n\\n- ***ECTL*** : **EMVProximityReader** Definition: Contactless proximity reader, with application conform to the standard EMV (standard initiated by Europay, Mastercard and Visa).  \\n\\n- ***CDFL*** : **CardOnFile** Definition: Card information are stored on a file.   */
    val vhclTagNtryMd: Vehicle1.VhclTagNtryMd? = null
)
{
    /**
    * Entry mode of the registration tag. VehicleTagEntryMode\\n\\n- ***TAGC*** : **Tag** Definition: Tag reading capabilities (RFID, etc.).  \\n\\n- ***PHYS*** : **Physical** Definition: Keyboard entry or OCR reading of embossing or printed data, either at time of transaction or after the event.  \\n\\n- ***BRCD*** : **BarCode** Definition: Bar code.  \\n\\n- ***MGST*** : **MagneticStripe** Definition: Magnetic stripe.  \\n\\n- ***CICC*** : **ICC** Definition: ICC (Integrated Circuit Card) with contact containing software applications conform to ISO 7816.  \\n\\n- ***DFLE*** : **AccountData** Definition: Account data on file.  \\n\\n- ***CTLS*** : **ProximityReader** Definition: Contactless proximity reader.  \\n\\n- ***ECTL*** : **EMVProximityReader** Definition: Contactless proximity reader, with application conform to the standard EMV (standard initiated by Europay, Mastercard and Visa).  \\n\\n- ***CDFL*** : **CardOnFile** Definition: Card information are stored on a file.  
    * Values: TAGC,PHYS,BRCD,MGST,CICC,DFLE,CTLS,ECTL,CDFL
    */
    enum class VhclTagNtryMd(val value: kotlin.String){
        TAGC("TAGC"),
        PHYS("PHYS"),
        BRCD("BRCD"),
        MGST("MGST"),
