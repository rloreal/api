...
import com.lorealconsulting.nexoretail.kotlin.models.CityOfBirth1
import com.lorealconsulting.nexoretail.kotlin.models.ProvinceOfBirth1

import kotlinx.serialization.Serializable
/**
 * Date and place of birth of a person. DateAndPlaceOfBirth
 * @param birthDt Date on which a person is born. BirthDate
 * @param cityOfBirth 
 * @param ctryOfBirth Country where a person was born. CountryOfBirth
 * @param atId 
 * @param prvcOfBirth 
 */
@Serializable
data class DateAndPlaceOfBirth1(
    /* Date on which a person is born. BirthDate */
    val birthDt: kotlin.String,
    val cityOfBirth: CityOfBirth1,
    /* Country where a person was born. CountryOfBirth */
    val ctryOfBirth: kotlin.String,
    /*  */
    val atId: kotlin.String? = null,
    val prvcOfBirth: ProvinceOfBirth1? = null
)
{
}
