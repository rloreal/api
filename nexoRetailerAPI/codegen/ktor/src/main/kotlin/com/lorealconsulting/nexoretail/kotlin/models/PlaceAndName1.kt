...
/**
 * Unambiguous reference to the location where the supplementary data must be inserted in the message instance.  In the case of XML, this is expressed by a valid XPath. PlaceAndName
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class PlaceAndName1(
