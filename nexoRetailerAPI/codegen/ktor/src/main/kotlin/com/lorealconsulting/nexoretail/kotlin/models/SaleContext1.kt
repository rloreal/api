...
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalSaleData
import com.lorealconsulting.nexoretail.kotlin.models.AllowedEntryMode
import com.lorealconsulting.nexoretail.kotlin.models.CashierIdentification
import com.lorealconsulting.nexoretail.kotlin.models.CashierLanguage
import com.lorealconsulting.nexoretail.kotlin.models.DeliveryNoteNumber
import com.lorealconsulting.nexoretail.kotlin.models.InvoiceNumber
import com.lorealconsulting.nexoretail.kotlin.models.PurchaseOrderNumber
import com.lorealconsulting.nexoretail.kotlin.models.RemainingAmount1
import com.lorealconsulting.nexoretail.kotlin.models.SaleIdentification
import com.lorealconsulting.nexoretail.kotlin.models.SaleReconciliationIdentification
import com.lorealconsulting.nexoretail.kotlin.models.SaleReferenceNumber
import com.lorealconsulting.nexoretail.kotlin.models.ShiftNumber
import com.lorealconsulting.nexoretail.kotlin.models.SponsoredMerchant
 ...
 */
@Serializable
data class SaleContext1(
    /*  */
    val atId: kotlin.String? = null,
    val addtlSaleData: AdditionalSaleData? = null,
    val allwdNtryMd: AllowedEntryMode? = null,
    val cshrId: CashierIdentification? = null,
    val cshrLang: CashierLanguage? = null,
    ...
    val dlvryNoteNb: DeliveryNoteNumber? = null,
    ...
    val invcNb: InvoiceNumber? = null,
    val purchsOrdrNb: PurchaseOrderNumber? = null,
    ...
    val rmngAmt: RemainingAmount1? = null,
    val saleId: SaleIdentification? = null,
    val saleRcncltnId: SaleReconciliationIdentification? = null,
    val saleRefNb: SaleReferenceNumber? = null,
    /* Scope of the token that identifies the payment mean of the customer. SaleTokenScope\\n\\n- ***MULT*** : **MultipleUse** Definition: The token is generated to recognise a customer for a longer period.  \\n\\n- ***SNGL*** : **SingleUse** Definition: The token is generated to recognise  a customer during the lifetime of a transaction.   */
    val saleTknScp: SaleContext1.SaleTknScp? = null,
    val shftNb: ShiftNumber? = null,
    /* True if the payment transaction is a partial payment of the sale transaction. SplitPayment */
    val spltPmt: kotlin.Boolean? = null,
    val spnsrdMrchnt: SponsoredMerchant? = null
)
{
    /**
    * Scope of the token that identifies the payment mean of the customer. SaleTokenScope\\n\\n- ***MULT*** : **MultipleUse** Definition: The token is generated to recognise a customer for a longer period.  \\n\\n- ***SNGL*** : **SingleUse** Definition: The token is generated to recognise  a customer during the lifetime of a transaction.  
