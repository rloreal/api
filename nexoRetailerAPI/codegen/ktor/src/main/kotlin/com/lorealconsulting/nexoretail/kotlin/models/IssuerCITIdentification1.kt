...
/**
 * Identification, given by the Issuer, of the transaction processed with the cardholder that legitimates this merchant initiated transaction. IssuerCITIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class IssuerCITIdentification1(
