...
import com.lorealconsulting.nexoretail.kotlin.models.DigestAlgorithm4
import com.lorealconsulting.nexoretail.kotlin.models.SignatureAlgorithm1
import com.lorealconsulting.nexoretail.kotlin.models.SignedAttributes1
import com.lorealconsulting.nexoretail.kotlin.models.SignerIdentification1

import kotlinx.serialization.Serializable
/**
 * Digital signature and identification of a signer. Signer
 * @param dgstAlgo 
 * @param sgntr Digital signature. Signature
 * @param sgntrAlgo 
 * @param atId 
 * @param sgndAttrbts 
 * @param sgnrId 
 * @param vrsn Version of the Cryptographic Message Syntax (CMS) data structure. Version
 */
@Serializable
data class Signer1AnyOf(
    val dgstAlgo: DigestAlgorithm4,
    /* Digital signature. Signature */
    val sgntr: kotlin.String,
    val sgntrAlgo: SignatureAlgorithm1,
    /*  */
    val atId: kotlin.String? = null,
    val sgndAttrbts: SignedAttributes1? = null,
    val sgnrId: SignerIdentification1? = null,
    /* Version of the Cryptographic Message Syntax (CMS) data structure. Version */
    val vrsn: java.math.BigDecimal? = null
)
{
}
