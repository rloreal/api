...
import com.lorealconsulting.nexoretail.kotlin.models.Issuer2

import kotlinx.serialization.Serializable
/**
 * Certificate issuer name and serial number (see ITU X.509). IssuerAndSerialNumber
 * @param issr 
 * @param srlNb Certificate serial number (see X.509). SerialNumber
 * @param atId 
 */
@Serializable
data class IssuerAndSerialNumber1(
    val issr: Issuer2,
    /* Certificate serial number (see X.509). SerialNumber */
    val srlNb: kotlin.String,
    /*  */
