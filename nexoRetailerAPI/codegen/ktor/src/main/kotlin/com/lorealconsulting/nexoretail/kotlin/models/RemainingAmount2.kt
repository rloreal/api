...
/**
 * Remaining amount to complete the sale transaction, if a partial payment has been completed for the sale transaction. RemainingAmount
 * @param `value` 
 * @param atId 
 */
@Serializable
data class RemainingAmount2(
