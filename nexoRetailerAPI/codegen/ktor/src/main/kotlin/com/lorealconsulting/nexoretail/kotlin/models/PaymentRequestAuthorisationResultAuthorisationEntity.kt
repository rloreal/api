 ...
 * @param type Type of identified entity.
 * @param country Country of the entity (ISO 3166-1 alpha-2 or alpha-3).
 * @param identification Identification of the entity.
 * @param issuer Entity assigning the identification (for example merchant, acceptor, acquirer, or tax authority).
 * @param shortName Name of the entity.
 */
@Serializable
data class PaymentRequestAuthorisationResultAuthorisationEntity(
    /* Type of identified entity. */
    val type: PaymentRequestAuthorisationResultAuthorisationEntity.Type,
    /* Country of the entity (ISO 3166-1 alpha-2 or alpha-3). */
    val country: kotlin.String? = null,
    /* Identification of the entity. */
    val identification: kotlin.String? = null,
    /* Entity assigning the identification (for example merchant, acceptor, acquirer, or tax authority). */
    val issuer: PaymentRequestAuthorisationResultAuthorisationEntity.Issuer? = null,
    /* Name of the entity. */
...
)
{
    ...
    */
    enum class Issuer(val value: kotlin.String){
        MERC("MERC"),
        ACCP("ACCP"),
        ITAG("ITAG"),
        ACQR("ACQR"),
