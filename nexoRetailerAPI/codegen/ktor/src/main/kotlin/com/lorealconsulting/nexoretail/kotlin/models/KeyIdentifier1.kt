...
import com.lorealconsulting.nexoretail.kotlin.models.KeyIdentification1
import com.lorealconsulting.nexoretail.kotlin.models.KeyVersion1

import kotlinx.serialization.Serializable
/**
 * Identification of a protection key without a session key, shared and previously exchanged between the initiator and the recipient. KeyIdentifier
 * @param keyId 
 * @param keyVrsn 
 * @param atId 
 * @param derivtnId Identification used for derivation of a unique key from a master key provided for the data protection. DerivationIdentification
 * @param seqNb Number of usages of the cryptographic key. SequenceNumber
 */
@Serializable
data class KeyIdentifier1(
    val keyId: KeyIdentification1,
    val keyVrsn: KeyVersion1,
    /*  */
    val atId: kotlin.String? = null,
    /* Identification used for derivation of a unique key from a master key provided for the data protection. DerivationIdentification */
    val derivtnId: kotlin.String? = null,
    /* Number of usages of the cryptographic key. SequenceNumber */
