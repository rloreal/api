...
import com.lorealconsulting.nexoretail.kotlin.models.MaximumCashBackAmount2
import com.lorealconsulting.nexoretail.kotlin.models.MinimumAmountToDeliver2
import com.lorealconsulting.nexoretail.kotlin.models.MinimumSplitAmount2
import com.lorealconsulting.nexoretail.kotlin.models.SaleCapabilities1

import kotlinx.serialization.Serializable
/**
 * Sale Retailer Environment for this message. SaleEnvironment
 * @param atId 
 * @param ccy Default currency associated with the sale system. Currency
 * @param dbtPrefrdFlg Flag if preferred type of payment is a debit transaction. DebitPreferredFlag
 * @param lltyHdlg Way of Loyalty handling. LoyaltyHandling\\n\\n- ***ALLO*** : **Allowed** Definition: The loyalty is accepted, but the POI has not to require or ask a loyalty card. The loyalty is involved by the payment card (e.g. an hybrid or linked card).   \\n\\n- ***DENY*** : **Forbidden** Definition: No loyalty card to read and loyalty transaction to process.  Any attempt to enter a pure loyalty card is rejected.  \\n\\n- ***PRCS*** : **Processed** Definition: The loyalty transaction is already processed, no loyalty card or loyalty transaction to process.  \\n\\n- ***PROP*** : **Proposed** Definition: The loyalty is accepted, and the POI has to ask a loyalty card. If the Customer does not enter a loyalty card, no loyalty transaction is realised.  \\n\\n- ***REQU*** : **Required** Definition: The loyalty is required, and the POI refuses the processing  of the message request if the cardholder does not enter a loyalty card.  
 * @param maxCshBckAmt 
 * @param minAmtToDlvr 
 * @param minSpltAmt 
 * @param saleCpblties 
 */
@Serializable
data class SaleEnvironment2(
    /*  */
    val atId: kotlin.String? = null,
    /* Default currency associated with the sale system. Currency */
    val ccy: kotlin.String? = null,
    /* Flag if preferred type of payment is a debit transaction. DebitPreferredFlag */
    val dbtPrefrdFlg: kotlin.Boolean? = null,
    /* Way of Loyalty handling. LoyaltyHandling\\n\\n- ***ALLO*** : **Allowed** Definition: The loyalty is accepted, but the POI has not to require or ask a loyalty card. The loyalty is involved by the payment card (e.g. an hybrid or linked card).   \\n\\n- ***DENY*** : **Forbidden** Definition: No loyalty card to read and loyalty transaction to process.  Any attempt to enter a pure loyalty card is rejected.  \\n\\n- ***PRCS*** : **Processed** Definition: The loyalty transaction is already processed, no loyalty card or loyalty transaction to process.  \\n\\n- ***PROP*** : **Proposed** Definition: The loyalty is accepted, and the POI has to ask a loyalty card. If the Customer does not enter a loyalty card, no loyalty transaction is realised.  \\n\\n- ***REQU*** : **Required** Definition: The loyalty is required, and the POI refuses the processing  of the message request if the cardholder does not enter a loyalty card.   */
    val lltyHdlg: SaleEnvironment2.LltyHdlg? = null,
    val maxCshBckAmt: MaximumCashBackAmount2? = null,
    val minAmtToDlvr: MinimumAmountToDeliver2? = null,
    val minSpltAmt: MinimumSplitAmount2? = null,
    val saleCpblties: SaleCapabilities1? = null
)
{
    /**
    * Way of Loyalty handling. LoyaltyHandling\\n\\n- ***ALLO*** : **Allowed** Definition: The loyalty is accepted, but the POI has not to require or ask a loyalty card. The loyalty is involved by the payment card (e.g. an hybrid or linked card).   \\n\\n- ***DENY*** : **Forbidden** Definition: No loyalty card to read and loyalty transaction to process.  Any attempt to enter a pure loyalty card is rejected.  \\n\\n- ***PRCS*** : **Processed** Definition: The loyalty transaction is already processed, no loyalty card or loyalty transaction to process.  \\n\\n- ***PROP*** : **Proposed** Definition: The loyalty is accepted, and the POI has to ask a loyalty card. If the Customer does not enter a loyalty card, no loyalty transaction is realised.  \\n\\n- ***REQU*** : **Required** Definition: The loyalty is required, and the POI refuses the processing  of the message request if the cardholder does not enter a loyalty card.  
    * Values: ALLO,DENY,PRCS,PROP,REQU
    */
    enum class LltyHdlg(val value: kotlin.String){
        ALLO("ALLO"),
        DENY("DENY"),
        PRCS("PRCS"),
        PROP("PROP"),
