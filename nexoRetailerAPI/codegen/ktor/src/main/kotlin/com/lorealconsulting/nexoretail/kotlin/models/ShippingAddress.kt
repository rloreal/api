...
import com.lorealconsulting.nexoretail.kotlin.models.AddressLine
import com.lorealconsulting.nexoretail.kotlin.models.BuildingNumber
import com.lorealconsulting.nexoretail.kotlin.models.CountryCode
import com.lorealconsulting.nexoretail.kotlin.models.CountrySubDivision1
import com.lorealconsulting.nexoretail.kotlin.models.Department1
import com.lorealconsulting.nexoretail.kotlin.models.PostCode
import com.lorealconsulting.nexoretail.kotlin.models.StreetName
import com.lorealconsulting.nexoretail.kotlin.models.SubDepartment
import com.lorealconsulting.nexoretail.kotlin.models.TownName1
...
data class ShippingAddress(
    ...
    val adrLine: AddressLine? = null,
    /* Identifies the nature of the postal address. AddressType\\n\\n- ***ADDR*** : **Postal** Definition: Address is the complete postal address.  \\n\\n- ***PBOX*** : **POBox** Definition: Address is a postal office (PO) box.  \\n\\n- ***HOME*** : **Residential** Definition: Address is the home address.  \\n\\n- ***BIZZ*** : **Business** Definition: Address is the business address.  \\n\\n- ***MLTO*** : **MailTo** Definition: Address is the address to which mail is sent.  \\n\\n- ***DLVY*** : **DeliveryTo** Definition: Address is the address to which delivery is to take place.   */
    val adrTp: ShippingAddress.AdrTp? = null,
    val bldgNb: BuildingNumber? = null,
    val ctryCd: CountryCode? = null,
    val ctrySubDvsn: CountrySubDivision1? = null,
    val dept: Department1? = null,
    val pstCd: PostCode? = null,
    val strtNm: StreetName? = null,
    val subDept: SubDepartment? = null,
    val twnNm: TownName1? = null
)
{
    /**
    * Identifies the nature of the postal address. AddressType\\n\\n- ***ADDR*** : **Postal** Definition: Address is the complete postal address.  \\n\\n- ***PBOX*** : **POBox** Definition: Address is a postal office (PO) box.  \\n\\n- ***HOME*** : **Residential** Definition: Address is the home address.  \\n\\n- ***BIZZ*** : **Business** Definition: Address is the business address.  \\n\\n- ***MLTO*** : **MailTo** Definition: Address is the address to which mail is sent.  \\n\\n- ***DLVY*** : **DeliveryTo** Definition: Address is the address to which delivery is to take place.  
