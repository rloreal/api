...
/**
 * Additional information related to the transaction like an Invoice or IndustryData (for example  hospitality, lodging, transportation). AdditionalInformation
 * @param id 
 * @param atId 
 * @param prtctdVal 
 * @param tp 
 ...
 */
@Serializable
data class AdditionalInformation9AnyOf(
