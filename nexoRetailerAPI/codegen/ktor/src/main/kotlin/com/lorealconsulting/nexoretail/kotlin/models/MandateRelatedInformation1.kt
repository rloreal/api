...
import com.lorealconsulting.nexoretail.kotlin.models.MandateIdentification1

import kotlinx.serialization.Serializable
/**
 * Provides further details of the mandate signed between the creditor and the debtor. MandateRelatedInformation
 * @param mndtId 
 * @param atId 
 * @param dtOfSgntr Date on which the direct debit mandate has been signed by the debtor. DateOfSignature
 * @param mndtImg Image of scanned signed mandate. MandateImage
 */
@Serializable
data class MandateRelatedInformation1(
    val mndtId: MandateIdentification1,
    /*  */
    val atId: kotlin.String? = null,
    /* Date on which the direct debit mandate has been signed by the debtor. DateOfSignature */
    val dtOfSgntr: kotlin.String? = null,
    /* Image of scanned signed mandate. MandateImage */
    val mndtImg: kotlin.String? = null
)
{
}
