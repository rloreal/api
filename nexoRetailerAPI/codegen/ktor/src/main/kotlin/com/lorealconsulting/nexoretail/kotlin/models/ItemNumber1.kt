...
/**
 * Hierarchical identification of a hardware component inside all the hardware component of the POI. It is composed of all item numbers of the upper level components, separated by the '.' character, ended by the item number of the current component. ItemNumber
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class ItemNumber1(
