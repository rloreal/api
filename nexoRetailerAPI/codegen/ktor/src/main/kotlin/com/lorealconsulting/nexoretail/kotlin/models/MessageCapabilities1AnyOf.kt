...
import com.lorealconsulting.nexoretail.kotlin.models.AvailableFormat1
import com.lorealconsulting.nexoretail.kotlin.models.AvailableLanguage1
import com.lorealconsulting.nexoretail.kotlin.models.Destination1

import kotlinx.serialization.Serializable
/**
 * Capabilities of the terminal to display or print message to the cardholder and the merchant. MessageCapabilities
 * @param dstn 
 * @param atId 
 * @param avlblFrmt 
 * @param avlblLang 
 * @param lineWidth Number of columns of the display or printer. LineWidth
 * @param nbOfLines Number of lines of the display. NumberOfLines
 */
@Serializable
data class MessageCapabilities1AnyOf(
    val dstn: Destination1,
    /*  */
    val atId: kotlin.String? = null,
    val avlblFrmt: AvailableFormat1? = null,
    val avlblLang: AvailableLanguage1? = null,
    /* Number of columns of the display or printer. LineWidth */
    val lineWidth: java.math.BigDecimal? = null,
    /* Number of lines of the display. NumberOfLines */
    val nbOfLines: java.math.BigDecimal? = null
)
{
}
