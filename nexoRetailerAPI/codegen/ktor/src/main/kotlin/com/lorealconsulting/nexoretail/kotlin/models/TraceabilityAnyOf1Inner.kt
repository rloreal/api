...
import com.lorealconsulting.nexoretail.kotlin.models.ProtocolName1
import com.lorealconsulting.nexoretail.kotlin.models.ProtocolVersion1
import com.lorealconsulting.nexoretail.kotlin.models.RelayIdentification

import kotlinx.serialization.Serializable
/**
 * Identification of partners involved in exchange from the merchant to the issuer, with the relative timestamp of their exchanges. Traceability
 * @param rlayId 
 * @param tracDtTmIn Date and time of incoming data exchange for relaying or processing. TraceDateTimeIn
 * @param tracDtTmOut Date and time of the outgoing exchange for relaying or processing. TraceDateTimeOut
 * @param atId 
 * @param prtcolNm 
 * @param prtcolVrsn 
 */
@Serializable
data class TraceabilityAnyOf1Inner(
    val rlayId: RelayIdentification,
    /* Date and time of incoming data exchange for relaying or processing. TraceDateTimeIn */
    val tracDtTmIn: kotlin.String,
    /* Date and time of the outgoing exchange for relaying or processing. TraceDateTimeOut */
    val tracDtTmOut: kotlin.String,
    /*  */
    val atId: kotlin.String? = null,
    val prtcolNm: ProtocolName1? = null,
    val prtcolVrsn: ProtocolVersion1? = null
)
{
}
