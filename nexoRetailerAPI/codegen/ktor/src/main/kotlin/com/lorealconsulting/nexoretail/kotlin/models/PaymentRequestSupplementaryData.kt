...
import com.lorealconsulting.nexoretail.kotlin.models.PaymentRequestSupplementaryDataAnyOf

import kotlinx.serialization.Serializable
/**
 * Additional information incorporated as an extension to the message.
 * @param envelope Technical element wrapping the supplementary data.
 * @param placeAndName Unambiguous reference to the location where the supplementary data must be inserted in the message instance.  In the case of XML, this is expressed by a valid XPath.
 */
@Serializable
data class PaymentRequestSupplementaryData(
    /* Technical element wrapping the supplementary data. */
    val envelope: kotlin.Any,
    ...
    val placeAndName: kotlin.String? = null
)
{
}
