...
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalResponseInformation2
import com.lorealconsulting.nexoretail.kotlin.models.ResponseReason1

import kotlinx.serialization.Serializable
/**
 * Response to an authorisation request. ResponseToAuthorisation
 * @param rspn Result of the transaction. Response\\n\\n- ***APPR*** : **Approved** Definition: Service has been successfuly provided.  \\n\\n- ***DECL*** : **Declined** Definition: Service is declined.  \\n\\n- ***PART*** : **PartialApproved** Definition: Service has been partialy provided.  \\n\\n- ***SUSP*** : **Suspended** Definition: Transaction has been received but hasn't been processed.  \\n\\n- ***TECH*** : **TechnicalError** Definition: Service cannot be provided for technical reason (eg timeout contacting the Issuer, security problem).  
 * @param atId 
 * @param addtlRspnInf 
 * @param rspnRsn 
 */
@Serializable
data class ResponseToAuthorisation1(
    /* Result of the transaction. Response\\n\\n- ***APPR*** : **Approved** Definition: Service has been successfuly provided.  \\n\\n- ***DECL*** : **Declined** Definition: Service is declined.  \\n\\n- ***PART*** : **PartialApproved** Definition: Service has been partialy provided.  \\n\\n- ***SUSP*** : **Suspended** Definition: Transaction has been received but hasn't been processed.  \\n\\n- ***TECH*** : **TechnicalError** Definition: Service cannot be provided for technical reason (eg timeout contacting the Issuer, security problem).   */
    val rspn: ResponseToAuthorisation1.Rspn,
    /*  */
    val atId: kotlin.String? = null,
    val addtlRspnInf: AdditionalResponseInformation2? = null,
    val rspnRsn: ResponseReason1? = null
)
{
    /**
    * Result of the transaction. Response\\n\\n- ***APPR*** : **Approved** Definition: Service has been successfuly provided.  \\n\\n- ***DECL*** : **Declined** Definition: Service is declined.  \\n\\n- ***PART*** : **PartialApproved** Definition: Service has been partialy provided.  \\n\\n- ***SUSP*** : **Suspended** Definition: Transaction has been received but hasn't been processed.  \\n\\n- ***TECH*** : **TechnicalError** Definition: Service cannot be provided for technical reason (eg timeout contacting the Issuer, security problem).  
    * Values: APPR,DECL,PART,SUSP,TECH
    */
