...
import com.lorealconsulting.nexoretail.kotlin.models.Charges2
import com.lorealconsulting.nexoretail.kotlin.models.DetailedCharges2
import com.lorealconsulting.nexoretail.kotlin.models.FirstAmount2
import com.lorealconsulting.nexoretail.kotlin.models.GracePeriod1
import com.lorealconsulting.nexoretail.kotlin.models.Instalment1AnyOf
import com.lorealconsulting.nexoretail.kotlin.models.Instalment1AnyOf1Inner
import com.lorealconsulting.nexoretail.kotlin.models.InstalmentPlan1
import com.lorealconsulting.nexoretail.kotlin.models.InterestRate1
import com.lorealconsulting.nexoretail.kotlin.models.LastAmount2
import com.lorealconsulting.nexoretail.kotlin.models.PlanIdentification2
import com.lorealconsulting.nexoretail.kotlin.models.PlanNotice2
import com.lorealconsulting.nexoretail.kotlin.models.SubsequentAmount2
import com.lorealconsulting.nexoretail.kotlin.models.TotalAmount7
 ...
 */
@Serializable
data class Instalment1(
    /*  */
    val atId: kotlin.String? = null,
    val chrgs: Charges2? = null,
    val dtldChrgs: DetailedCharges2? = null,
    val frstAmt: FirstAmount2? = null,
    /* Date of the first payment. FirstPaymentDate */
    val frstPmtDt: kotlin.String? = null,
    val gracePrd: GracePeriod1? = null,
    val instlmtPlan: InstalmentPlan1? = null,
    /* Number of period units between consecutive payments. InstalmentPeriod */
    val instlmtPrd: java.math.BigDecimal? = null,
    val intrstRate: InterestRate1? = null,
    val lastAmt: LastAmount2? = null,
    val planId: PlanIdentification2? = null,
    val planNtce: PlanNotice2? = null,
    /* Type of the Plan Owner. PlanOwner\\n\\n- ***ACCP*** : **Acceptor** Definition: Plan owner is an acceptor.  \\n\\n- ***ACQR*** : **Acquirer** Definition: Plan owner is an acquirer.  \\n\\n- ***ISSR*** : **Issuer** Definition: Plan owner is an issuer.  \\n\\n- ***OTHN*** : **OtherNational** Definition: plan owner type is other national.  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: plan owner type is other private.   */
    val planOwnr: Instalment1.PlanOwnr? = null,
    /* Period unit between consecutive payments (for example day, month, year). PeriodUnit\\n\\n- ***YEAR*** : **Annual** Definition: Event takes place every year or once a year.  \\n\\n- ***MNTH*** : **Monthly** Definition: Event takes place every month or once a month.  \\n\\n- ***QURT*** : **Quarterly** Definition: Event takes place every three months or four times a year.  \\n\\n- ***MIAN*** : **SemiAnnual** Definition: Event takes place every six months or two times a year.  \\n\\n- ***WEEK*** : **Weekly** Definition: Event takes place once a week.  \\n\\n- ***DAIL*** : **Daily** Definition: Event takes place every day.  \\n\\n- ***TEND*** : **TenDays** Definition: Event takes place every ten business days.   */
    val prdUnit: Instalment1.PrdUnit? = null,
    val sbsqntAmt: SubsequentAmount2? = null,
