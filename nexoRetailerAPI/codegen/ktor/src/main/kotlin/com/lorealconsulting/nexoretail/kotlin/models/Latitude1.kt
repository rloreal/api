...
/**
 * Angular distance of a location on the earth south or north of the equator.  The latitude is measured in degrees, minutes and seconds, following by \"N\" for the north and \"S\" for the south of the equator. For example: 48°51'29\" N the Eiffel Tower latitude. Latitude
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class Latitude1(
