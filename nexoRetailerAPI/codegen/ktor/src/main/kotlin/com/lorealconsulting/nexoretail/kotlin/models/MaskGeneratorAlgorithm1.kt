...
/**
 * Mask generator function cryptographic algorithm and parameters. MaskGeneratorAlgorithm
 * @param algo Mask generator function cryptographic algorithm. Algorithm\\n\\n- ***MGF1*** : **MGF1** Definition: Generator Function, used for RSA encryption and RSA igital signature (PKCS #1 version 2.1) - (ASN.1 Object Identifier: id-mgf1).  
 * @param atId 
 * @param `param` 
 */
@Serializable
data class MaskGeneratorAlgorithm1(
    /* Mask generator function cryptographic algorithm. Algorithm\\n\\n- ***MGF1*** : **MGF1** Definition: Generator Function, used for RSA encryption and RSA igital signature (PKCS #1 version 2.1) - (ASN.1 Object Identifier: id-mgf1).   */
    val algo: MaskGeneratorAlgorithm1.Algo,
    /*  */
