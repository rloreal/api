...
/**
 * Identifier assigned by the merchant identifying a set of POI (Point Of Interaction) terminals performing some categories of transactions. GroupIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class GroupIdentification1(
