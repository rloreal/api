...
/**
 * Check guarantee card number.  The human readable number from the Check Guarantee Card that is presented during the check tendering process. CheckCardNumber
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class CheckCardNumber1(
