...
import com.lorealconsulting.nexoretail.kotlin.models.Action1
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalAvailableProduct1
import com.lorealconsulting.nexoretail.kotlin.models.AllowedProductCode1
import com.lorealconsulting.nexoretail.kotlin.models.AuthorisationResult3
import com.lorealconsulting.nexoretail.kotlin.models.Balance7
import com.lorealconsulting.nexoretail.kotlin.models.CurrencyConversionEligibility1
import com.lorealconsulting.nexoretail.kotlin.models.NotAllowedProductCode1
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedBalance1

import kotlinx.serialization.Serializable
/**
 * Result of the transaction processing. TransactionResponse
 * @param authstnRslt 
 * @param atId 
 * @param actn 
 * @param addtlAvlblPdct 
 * @param allwdPdctCd 
 * @param bal 
 * @param ccyConvsElgblty 
 * @param notAllwdPdctCd 
 * @param prtctdBal 
 */
@Serializable
data class TransactionResponse1(
    val authstnRslt: AuthorisationResult3,
    /*  */
    val atId: kotlin.String? = null,
    val actn: Action1? = null,
    val addtlAvlblPdct: AdditionalAvailableProduct1? = null,
    val allwdPdctCd: AllowedProductCode1? = null,
    val bal: Balance7? = null,
    val ccyConvsElgblty: CurrencyConversionEligibility1? = null,
    val notAllwdPdctCd: NotAllowedProductCode1? = null,
    val prtctdBal: ProtectedBalance1? = null
)
{
}
