...
import com.lorealconsulting.nexoretail.kotlin.models.DisplayOutput1
 ...
 */
@Serializable
data class EnableServiceRequest1(
    /* Action to realise on a transaction. TransactionAction\\n\\n- ***STAR*** : **StartTransaction** Definition: Start a transaction by a swipe ahead mechanism, with the services which are enabled.  \\n\\n- ***STOP*** : **Stop** Definition: Keep quite after a swipe ahead mechanism.   */
    val txActn: EnableServiceRequest1.TxActn,
    /*  */
    val atId: kotlin.String? = null,
    val dispOutpt: DisplayOutput1? = null,
    /* Services enabled before the start-up of a transaction. ServicesEnabled\\n\\n- ***FSPQ*** : **FinancialPaymentRequest** Definition: The Sale System requests to the POI System to perform a payment(Purchase/Refund/PWCB/MOTO Payment/...).  \\n\\n- ***FSRQ*** : **FinancialReversalRequest** Definition: The Sale System requests to the POI System to perform a reversal partial or complete to cancel a former payment service.  \\n\\n- ***FSIQ*** : **FinancialBalanceInquiryRequest** Definition: The Sale System requests to the POI System to perform balance inquiry on the main account.  \\n\\n- ***FSBQ*** : **FinancialBatchRequest** Definition: The Batch message pair is used to request or get the result of transactions (payment, loyalty and reversal) performed without connection to the Sale system (Payment delivery).  \\n\\n- ***FSLQ*** : **FinancialLoyaltyRequest** Definition: The Sale System requests to the POI System a loyalty service like loading or redeem.  \\n\\n- ***FSVQ*** : **FinancialStoredValueRequest** Definition: The Sale System requests to the POI System to manage a stored value card or account (eg. Load, Payment, Reimbursement).  \\n\\n- ***FSEQ*** : **FinancialEnableServiceRequest** Definition: The Sale System requests to the POI System to enable a service on its side.  \\n\\n- ***FSAQ*** : **FinancialCardAcquisitionRequest** Definition: The Sale System requests to the POI System to handle a card data acquisition on the card reader.  \\n\\n- ***FSCQ*** : **FinancialReconciliationRequest** Definition: The Sale System request to the POI System different kinds of transaction reconciliation.    */
    val svcsNbld: EnableServiceRequest1.SvcsNbld? = null
)
{
    /**
    * Action to realise on a transaction. TransactionAction\\n\\n- ***STAR*** : **StartTransaction** Definition: Start a transaction by a swipe ahead mechanism, with the services which are enabled.  \\n\\n- ***STOP*** : **Stop** Definition: Keep quite after a swipe ahead mechanism.  
