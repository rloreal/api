...
/**
 * Category code conform to ISO 18245, related to the type of services or goods the merchant provides for the transaction. MerchantCategoryCode
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class MerchantCategoryCode1(
