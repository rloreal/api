...
import com.lorealconsulting.nexoretail.kotlin.models.Parameter6

import kotlinx.serialization.Serializable
/**
 * Algorithm to encrypt the key encryption key (KEK). KeyEncryptionAlgorithm
 * @param algo Asymmetric encryption algorithm of a transport key. Algorithm\\n\\n- ***ERSA*** : **RSAEncryption** Definition: RSA encryption algorithm - (ASN.1 Object Identifier: rsaEncryption).  \\n\\n- ***RSAO*** : **RSAES-OAEP** Definition: RSA encryption scheme based on Optimal Asymmetric Encryption scheme (PKCS #1 version 2.1) - (ASN.1 Object Identifier: id-RSAES-OAEP).  
 * @param atId 
 * @param `param` 
 */
@Serializable
data class KeyEncryptionAlgorithm3(
    /* Asymmetric encryption algorithm of a transport key. Algorithm\\n\\n- ***ERSA*** : **RSAEncryption** Definition: RSA encryption algorithm - (ASN.1 Object Identifier: rsaEncryption).  \\n\\n- ***RSAO*** : **RSAES-OAEP** Definition: RSA encryption scheme based on Optimal Asymmetric Encryption scheme (PKCS #1 version 2.1) - (ASN.1 Object Identifier: id-RSAES-OAEP).   */
    val algo: KeyEncryptionAlgorithm3.Algo,
    /*  */
    val atId: kotlin.String? = null,
    val `param`: Parameter6? = null
)
{
    /**
    * Asymmetric encryption algorithm of a transport key. Algorithm\\n\\n- ***ERSA*** : **RSAEncryption** Definition: RSA encryption algorithm - (ASN.1 Object Identifier: rsaEncryption).  \\n\\n- ***RSAO*** : **RSAES-OAEP** Definition: RSA encryption scheme based on Optimal Asymmetric Encryption scheme (PKCS #1 version 2.1) - (ASN.1 Object Identifier: id-RSAES-OAEP).  
