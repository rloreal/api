...
import com.lorealconsulting.nexoretail.kotlin.models.TMSIdentification1

import kotlinx.serialization.Serializable
/**
 * Instructs the point of interaction (POI) how to contact the host to initiate the maintenance of the terminal. TMSTrigger
 * @param tmSCtctLvl Level of urgency in contacting the maintenance. TMSContactLevel\\n\\n- ***CRIT*** : **Critical** Definition: Terminal management system has to be contacted before the next transaction.  \\n\\n- ***ASAP*** : **AsSoonAsPossible** Definition: Terminal management system has to be contacted as soon as possible (for example after reconciliation).  \\n\\n- ***DTIM*** : **DateTime** Definition: Terminal management system has to be contacted at the date and time provided.  
 * @param atId 
 * @param tmSCtctDtTm Date and time for calling the maintenance. TMSContactDateTime
 * @param tmSId 
 */
@Serializable
data class TMSTrigger1(
    /* Level of urgency in contacting the maintenance. TMSContactLevel\\n\\n- ***CRIT*** : **Critical** Definition: Terminal management system has to be contacted before the next transaction.  \\n\\n- ***ASAP*** : **AsSoonAsPossible** Definition: Terminal management system has to be contacted as soon as possible (for example after reconciliation).  \\n\\n- ***DTIM*** : **DateTime** Definition: Terminal management system has to be contacted at the date and time provided.   */
    val tmSCtctLvl: TMSTrigger1.TmSCtctLvl,
    /*  */
    val atId: kotlin.String? = null,
    /* Date and time for calling the maintenance. TMSContactDateTime */
    val tmSCtctDtTm: kotlin.String? = null,
    val tmSId: TMSIdentification1? = null
)
{
    /**
    * Level of urgency in contacting the maintenance. TMSContactLevel\\n\\n- ***CRIT*** : **Critical** Definition: Terminal management system has to be contacted before the next transaction.  \\n\\n- ***ASAP*** : **AsSoonAsPossible** Definition: Terminal management system has to be contacted as soon as possible (for example after reconciliation).  \\n\\n- ***DTIM*** : **DateTime** Definition: Terminal management system has to be contacted at the date and time provided.  
    * Values: CRIT,ASAP,DTIM
    */
    enum class TmSCtctLvl(val value: kotlin.String){
        CRIT("CRIT"),
        ASAP("ASAP"),
        DTIM("DTIM");
    }
