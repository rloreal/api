...
/**
 * Identification of the transaction by the host in charge of the stored value transaction. HostTransactionIdentification
 * @param txDtTm Local date and time of the transaction assigned by the POI (Point Of Interaction). TransactionDateTime
 * @param txRef 
 * @param atId 
 */
@Serializable
data class HostTransactionIdentification1(
