...
import com.lorealconsulting.nexoretail.kotlin.models.Address3
import com.lorealconsulting.nexoretail.kotlin.models.ClientCertificate1
import com.lorealconsulting.nexoretail.kotlin.models.SecurityProfile3
import com.lorealconsulting.nexoretail.kotlin.models.ServerCertificate1
import com.lorealconsulting.nexoretail.kotlin.models.ServerCertificateIdentifier1
import com.lorealconsulting.nexoretail.kotlin.models.UserName2

import kotlinx.serialization.Serializable
/**
 * Access information to reach the target host. RemoteAccess
 * @param adr 
 * @param atId 
 * @param accsCd Password authenticating the client. AccessCode
 * @param clntCert 
 * @param sctyPrfl 
 * @param svrCert 
 * @param svrCertIdr 
 ...
 */
@Serializable
data class RemoteAccess1(
    val adr: Address3,
    /*  */
    val atId: kotlin.String? = null,
    /* Password authenticating the client. AccessCode */
    val accsCd: kotlin.String? = null,
    val clntCert: ClientCertificate1? = null,
    val sctyPrfl: SecurityProfile3? = null,
    val svrCert: ServerCertificate1? = null,
    val svrCertIdr: ServerCertificateIdentifier1? = null,
    val usrNm: UserName2? = null
)
{
}
