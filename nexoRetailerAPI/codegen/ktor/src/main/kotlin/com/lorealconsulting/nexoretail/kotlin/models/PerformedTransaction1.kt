...
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyResult3
import com.lorealconsulting.nexoretail.kotlin.models.POIReconciliationIdentification3
import com.lorealconsulting.nexoretail.kotlin.models.POITransactionIdentification3
import com.lorealconsulting.nexoretail.kotlin.models.PaymentResult1
import com.lorealconsulting.nexoretail.kotlin.models.PerformedTransaction1AnyOf
import com.lorealconsulting.nexoretail.kotlin.models.PerformedTransaction1AnyOf1Inner
import com.lorealconsulting.nexoretail.kotlin.models.Response2
import com.lorealconsulting.nexoretail.kotlin.models.ReversedAmount4
import com.lorealconsulting.nexoretail.kotlin.models.SaleTransactionIdentification3
 ...
 */
@Serializable
data class PerformedTransaction1(
    val rspn: Response2,
    /*  */
    val atId: kotlin.String? = null,
    val lltyRslt: LoyaltyResult3? = null,
    val poIRcncltnId: POIReconciliationIdentification3? = null,
    val poITxId: POITransactionIdentification3? = null,
    val pmtRslt: PaymentResult1? = null,
    val rvsdAmt: ReversedAmount4? = null,
    val saleTxId: SaleTransactionIdentification3? = null
)
{
}
