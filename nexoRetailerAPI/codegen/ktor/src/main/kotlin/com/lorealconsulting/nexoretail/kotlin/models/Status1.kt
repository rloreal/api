...
import com.lorealconsulting.nexoretail.kotlin.models.VersionNumber1

import kotlinx.serialization.Serializable
/**
 * Status of the POI (Point Of Interaction) component. Status
 * @param atId 
 * @param sts Current status of the component. Status\\n\\n- ***WAIT*** : **WaitingActivation** Definition: Component not yet activated.  \\n\\n- ***OUTD*** : **OutOfOrder** Definition: Component not working properly.  \\n\\n- ***OPER*** : **InOperation** Definition: Component activated and in operation.  \\n\\n- ***DACT*** : **Deactivated** Definition: Component has been deactivated.  
 * @param vrsnNb 
 * @param xpryDt Expiration date of the component. ExpiryDate
 */
@Serializable
data class Status1(
    /*  */
    val atId: kotlin.String? = null,
    /* Current status of the component. Status\\n\\n- ***WAIT*** : **WaitingActivation** Definition: Component not yet activated.  \\n\\n- ***OUTD*** : **OutOfOrder** Definition: Component not working properly.  \\n\\n- ***OPER*** : **InOperation** Definition: Component activated and in operation.  \\n\\n- ***DACT*** : **Deactivated** Definition: Component has been deactivated.   */
    val sts: Status1.Sts? = null,
    val vrsnNb: VersionNumber1? = null,
    /* Expiration date of the component. ExpiryDate */
    val xpryDt: kotlin.String? = null
)
{
    /**
    * Current status of the component. Status\\n\\n- ***WAIT*** : **WaitingActivation** Definition: Component not yet activated.  \\n\\n- ***OUTD*** : **OutOfOrder** Definition: Component not working properly.  \\n\\n- ***OPER*** : **InOperation** Definition: Component activated and in operation.  \\n\\n- ***DACT*** : **Deactivated** Definition: Component has been deactivated.  
    * Values: WAIT,OUTD,OPER,DACT
    */
    enum class Sts(val value: kotlin.String){
        WAIT("WAIT"),
        OUTD("OUTD"),
        OPER("OPER"),
        DACT("DACT");
