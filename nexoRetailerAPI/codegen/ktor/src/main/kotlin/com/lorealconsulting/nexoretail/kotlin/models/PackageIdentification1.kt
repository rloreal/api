...
import com.lorealconsulting.nexoretail.kotlin.models.Country2
import com.lorealconsulting.nexoretail.kotlin.models.Identification15
import com.lorealconsulting.nexoretail.kotlin.models.ShortName1

import kotlinx.serialization.Serializable
/**
 * Identification of the software packages of which the chunk belongs. PackageIdentification
 * @param id 
 * @param atId 
 * @param ctry 
 * @param issr |- Entity assigning the identification (for example merchant, acceptor, acquirer, or tax authority). Issuer  - ***OPOI*** : **OriginatingPOI** Definition: Point Of Interaction initiating the card payment transaction.  \\n\\n- ***MERC*** : **Merchant** Definition: Merchant providing goods and service in the card payment transaction.   - ***ACCP*** : **Acceptor** Definition: Card acceptor, party accepting the card and presenting transaction data to the acquirer.  \\n\\n- ***ITAG*** : **IntermediaryAgent** Definition: Party acting on behalf of other parties to process or forward data to other parties.  \\n\\n- ***ACQR*** : **Acquirer** Definition: Entity acquiring card transactions.  \\n\\n- ***CISS*** : **CardIssuer** Definition: Party that issues cards.  \\n\\n- ***DLIS*** : **DelegateIssuer** Definition: Party to whom the card issuer delegates to authorise card payment transactions.  \\n\\n- ***MTMG*** : **MasterTerminalManager** Definition: Responsible for the maintenance of a card payment acceptance terminal.  \\n\\n- ***TAXH*** : **TaxAuthority** Definition: Tax authority.  \\n\\n- ***TMGT*** : **TerminalManager** Definition: Responsible for one or several maintenance functions of a card payment acceptance terminal.  
 * @param shrtNm 
 ...
 */
@Serializable
data class PackageIdentification1(
    val id: Identification15,
    /*  */
    val atId: kotlin.String? = null,
    val ctry: Country2? = null,
    /* |- Entity assigning the identification (for example merchant, acceptor, acquirer, or tax authority). Issuer  - ***OPOI*** : **OriginatingPOI** Definition: Point Of Interaction initiating the card payment transaction.  \\n\\n- ***MERC*** : **Merchant** Definition: Merchant providing goods and service in the card payment transaction.   - ***ACCP*** : **Acceptor** Definition: Card acceptor, party accepting the card and presenting transaction data to the acquirer.  \\n\\n- ***ITAG*** : **IntermediaryAgent** Definition: Party acting on behalf of other parties to process or forward data to other parties.  \\n\\n- ***ACQR*** : **Acquirer** Definition: Entity acquiring card transactions.  \\n\\n- ***CISS*** : **CardIssuer** Definition: Party that issues cards.  \\n\\n- ***DLIS*** : **DelegateIssuer** Definition: Party to whom the card issuer delegates to authorise card payment transactions.  \\n\\n- ***MTMG*** : **MasterTerminalManager** Definition: Responsible for the maintenance of a card payment acceptance terminal.  \\n\\n- ***TAXH*** : **TaxAuthority** Definition: Tax authority.  \\n\\n- ***TMGT*** : **TerminalManager** Definition: Responsible for one or several maintenance functions of a card payment acceptance terminal.   */
    val issr: PackageIdentification1.Issr? = null,
    val shrtNm: ShortName1? = null,
    /* Type of identified entity. Type\\n\\n- ***OPOI*** : **OriginatingPOI** Definition: Point Of Interaction initiating the card payment transaction.  \\n\\n- ***MERC*** : **Merchant** Definition: Merchant providing goods and service in the card payment transaction.  \\n\\n- ***ACCP*** : **Acceptor** Definition: Card acceptor, party accepting the card and presenting transaction data to the acquirer.  \\n\\n- ***ITAG*** : **IntermediaryAgent** Definition: Party acting on behalf of other parties to process or forward data to other parties.  \\n\\n- ***ACQR*** : **Acquirer** Definition: Entity acquiring card transactions.  \\n\\n- ***CISS*** : **CardIssuer** Definition: Party that issues cards.  \\n\\n- ***DLIS*** : **DelegateIssuer** Definition: Party to whom the card issuer delegates to authorise card payment transactions.  \\n\\n- ***MTMG*** : **MasterTerminalManager** Definition: Responsible for the maintenance of a card payment acceptance terminal.  \\n\\n- ***TAXH*** : **TaxAuthority** Definition: Tax authority.  \\n\\n- ***TMGT*** : **TerminalManager** Definition: Responsible for one or several maintenance functions of a card payment acceptance terminal.   */
    val tp: PackageIdentification1.Tp? = null
)
{
    /**
    * |- Entity assigning the identification (for example merchant, acceptor, acquirer, or tax authority). Issuer  - ***OPOI*** : **OriginatingPOI** Definition: Point Of Interaction initiating the card payment transaction.  \\n\\n- ***MERC*** : **Merchant** Definition: Merchant providing goods and service in the card payment transaction.   - ***ACCP*** : **Acceptor** Definition: Card acceptor, party accepting the card and presenting transaction data to the acquirer.  \\n\\n- ***ITAG*** : **IntermediaryAgent** Definition: Party acting on behalf of other parties to process or forward data to other parties.  \\n\\n- ***ACQR*** : **Acquirer** Definition: Entity acquiring card transactions.  \\n\\n- ***CISS*** : **CardIssuer** Definition: Party that issues cards.  \\n\\n- ***DLIS*** : **DelegateIssuer** Definition: Party to whom the card issuer delegates to authorise card payment transactions.  \\n\\n- ***MTMG*** : **MasterTerminalManager** Definition: Responsible for the maintenance of a card payment acceptance terminal.  \\n\\n- ***TAXH*** : **TaxAuthority** Definition: Tax authority.  \\n\\n- ***TMGT*** : **TerminalManager** Definition: Responsible for one or several maintenance functions of a card payment acceptance terminal.  
