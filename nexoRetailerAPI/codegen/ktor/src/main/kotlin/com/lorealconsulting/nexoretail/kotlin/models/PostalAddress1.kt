...
import com.lorealconsulting.nexoretail.kotlin.models.AddressLine1
import com.lorealconsulting.nexoretail.kotlin.models.BuildingNumber1
import com.lorealconsulting.nexoretail.kotlin.models.CountryCode1
import com.lorealconsulting.nexoretail.kotlin.models.CountrySubDivision3
import com.lorealconsulting.nexoretail.kotlin.models.Department3
import com.lorealconsulting.nexoretail.kotlin.models.PostCode1
import com.lorealconsulting.nexoretail.kotlin.models.StreetName1
import com.lorealconsulting.nexoretail.kotlin.models.SubDepartment1
import com.lorealconsulting.nexoretail.kotlin.models.TownName3

import kotlinx.serialization.Serializable
/**
 * Postal address of the entity. PostalAddress
 * @param atId 
 * @param adrLine 
 * @param adrTp Identifies the nature of the postal address. AddressType\\n\\n- ***ADDR*** : **Postal** Definition: Address is the complete postal address.  \\n\\n- ***PBOX*** : **POBox** Definition: Address is a postal office (PO) box.  \\n\\n- ***HOME*** : **Residential** Definition: Address is the home address.  \\n\\n- ***BIZZ*** : **Business** Definition: Address is the business address.  \\n\\n- ***MLTO*** : **MailTo** Definition: Address is the address to which mail is sent.  \\n\\n- ***DLVY*** : **DeliveryTo** Definition: Address is the address to which delivery is to take place.  
 * @param bldgNb 
 * @param ctryCd 
 * @param ctrySubDvsn 
 * @param dept 
 ...
 */
@Serializable
data class PostalAddress1(
    /*  */
    val atId: kotlin.String? = null,
    val adrLine: AddressLine1? = null,
    /* Identifies the nature of the postal address. AddressType\\n\\n- ***ADDR*** : **Postal** Definition: Address is the complete postal address.  \\n\\n- ***PBOX*** : **POBox** Definition: Address is a postal office (PO) box.  \\n\\n- ***HOME*** : **Residential** Definition: Address is the home address.  \\n\\n- ***BIZZ*** : **Business** Definition: Address is the business address.  \\n\\n- ***MLTO*** : **MailTo** Definition: Address is the address to which mail is sent.  \\n\\n- ***DLVY*** : **DeliveryTo** Definition: Address is the address to which delivery is to take place.   */
    val adrTp: PostalAddress1.AdrTp? = null,
    val bldgNb: BuildingNumber1? = null,
    val ctryCd: CountryCode1? = null,
    val ctrySubDvsn: CountrySubDivision3? = null,
    val dept: Department3? = null,
    val pstCd: PostCode1? = null,
    val strtNm: StreetName1? = null,
    val subDept: SubDepartment1? = null,
    val twnNm: TownName3? = null
)
{
    /**
    * Identifies the nature of the postal address. AddressType\\n\\n- ***ADDR*** : **Postal** Definition: Address is the complete postal address.  \\n\\n- ***PBOX*** : **POBox** Definition: Address is a postal office (PO) box.  \\n\\n- ***HOME*** : **Residential** Definition: Address is the home address.  \\n\\n- ***BIZZ*** : **Business** Definition: Address is the business address.  \\n\\n- ***MLTO*** : **MailTo** Definition: Address is the address to which mail is sent.  \\n\\n- ***DLVY*** : **DeliveryTo** Definition: Address is the address to which delivery is to take place.  
    ...
    */
    enum class AdrTp(val value: kotlin.String){
        ADDR("ADDR"),
        PBOX("PBOX"),
        HOME("HOME"),
        BIZZ("BIZZ"),
