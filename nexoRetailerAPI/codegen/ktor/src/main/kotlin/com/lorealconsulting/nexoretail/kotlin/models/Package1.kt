...
import com.lorealconsulting.nexoretail.kotlin.models.Package1AnyOf
import com.lorealconsulting.nexoretail.kotlin.models.PackageBlock1
import com.lorealconsulting.nexoretail.kotlin.models.PackageIdentification1

import kotlinx.serialization.Serializable
/**
 * 
 * @param atId 
 * @param offsetEnd Following place of the last following PackageBlock in the full software package identified through PackageIdentification. OffsetEnd
 * @param offsetStart Place of the first following PackageBlock, beginning with 0, in the full software package identified through PackageIdentification. OffsetStart
 * @param packgBlck 
 * @param packgId 
 * @param packgLngth Full length of software package identified through PackageIdentification. PackageLength
 */
@Serializable
data class Package1(
    /*  */
    val atId: kotlin.String? = null,
    /* Following place of the last following PackageBlock in the full software package identified through PackageIdentification. OffsetEnd */
    val offsetEnd: java.math.BigDecimal? = null,
    /* Place of the first following PackageBlock, beginning with 0, in the full software package identified through PackageIdentification. OffsetStart */
    val offsetStart: java.math.BigDecimal? = null,
    val packgBlck: PackageBlock1? = null,
    val packgId: PackageIdentification1? = null,
    /* Full length of software package identified through PackageIdentification. PackageLength */
    val packgLngth: java.math.BigDecimal? = null
)
{
}
