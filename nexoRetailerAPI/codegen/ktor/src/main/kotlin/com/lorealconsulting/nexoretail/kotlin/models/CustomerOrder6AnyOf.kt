...
import com.lorealconsulting.nexoretail.kotlin.models.AccessedBy1
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalInformation5
import com.lorealconsulting.nexoretail.kotlin.models.CurrentAmount2
import com.lorealconsulting.nexoretail.kotlin.models.CustomerOrderIdentification1
import com.lorealconsulting.nexoretail.kotlin.models.ForecastedAmount2
import com.lorealconsulting.nexoretail.kotlin.models.SaleReferenceIdentification2

import kotlinx.serialization.Serializable
/**
 * Customer order attached to a customer, recorded in the POI system. CustomerOrder
 * @param cstmrOrdrId 
 * @param frcstdAmt 
 * @param saleRefId 
 * @param startDt Date time of the beginning of an operation. StartDate
 * @param atId 
 * @param accsdBy 
 * @param addtlInf 
 * @param ccy Currency of monetary amount. Currency
 * @param curAmt 
 * @param endDt Date time of the end of an operation. EndDate
 * @param opnOrdrStat Specifies if a customer order is currently open. OpenOrderState
 * @param unit Unit of amount. Unit\\n\\n- ***MONE*** : **Monetary** Definition: The amount is expressed in a monetary value in a currency.  \\n\\n- ***POIN*** : **Point** Definition: The amount is expressed in point.  
 */
@Serializable
data class CustomerOrder6AnyOf(
    val cstmrOrdrId: CustomerOrderIdentification1,
    val frcstdAmt: ForecastedAmount2,
    val saleRefId: SaleReferenceIdentification2,
    /* Date time of the beginning of an operation. StartDate */
    val startDt: kotlin.String,
    /*  */
    val atId: kotlin.String? = null,
    val accsdBy: AccessedBy1? = null,
    val addtlInf: AdditionalInformation5? = null,
    /* Currency of monetary amount. Currency */
    val ccy: kotlin.String? = null,
    val curAmt: CurrentAmount2? = null,
    /* Date time of the end of an operation. EndDate */
    val endDt: kotlin.String? = null,
    /* Specifies if a customer order is currently open. OpenOrderState */
    val opnOrdrStat: kotlin.Boolean? = null,
    /* Unit of amount. Unit\\n\\n- ***MONE*** : **Monetary** Definition: The amount is expressed in a monetary value in a currency.  \\n\\n- ***POIN*** : **Point** Definition: The amount is expressed in point.   */
    val unit: CustomerOrder6AnyOf.Unit? = null
)
{
    /**
    * Unit of amount. Unit\\n\\n- ***MONE*** : **Monetary** Definition: The amount is expressed in a monetary value in a currency.  \\n\\n- ***POIN*** : **Point** Definition: The amount is expressed in point.  
