...
/**
 * Level of authentication for a given type – e.g. value assigned by scheme rules or by bilateral agreements. AuthenticationLevel
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class AuthenticationLevel1(
