...
import com.lorealconsulting.nexoretail.kotlin.models.AttributeValue1

import kotlinx.serialization.Serializable
/**
 * Relative distinguished name inside a X.509 certificate. RelativeDistinguishedName
 * @param attrTp Type of attribute of a distinguished name (see X.500). AttributeType\\n\\n- ***CNAT*** : **CommonName** Definition: Common name of the attribute (ASN.1 Object Identifier: id-at-commonName).  \\n\\n- ***LATT*** : **Locality** Definition: Locality of the attribute (ASN.1 Object Identifier: id-at-localityName).  \\n\\n- ***OATT*** : **OrganisationName** Definition: Organization name of the attribute (ASN.1 Object Identifier: id-at-organizationName).  \\n\\n- ***OUAT*** : **OrganisationUnitName** Definition: Organization unit name of the attribute (ASN.1 Object Identifier: id-at-organizationalUnitName).  \\n\\n- ***CATT*** : **CountryName** Definition: Country name of the attribute (ASN.1 Object Identifier: id-at-countryName).  
 * @param attrVal 
 * @param atId 
 */
@Serializable
data class RelativeDistinguishedName1AnyOf(
    /* Type of attribute of a distinguished name (see X.500). AttributeType\\n\\n- ***CNAT*** : **CommonName** Definition: Common name of the attribute (ASN.1 Object Identifier: id-at-commonName).  \\n\\n- ***LATT*** : **Locality** Definition: Locality of the attribute (ASN.1 Object Identifier: id-at-localityName).  \\n\\n- ***OATT*** : **OrganisationName** Definition: Organization name of the attribute (ASN.1 Object Identifier: id-at-organizationName).  \\n\\n- ***OUAT*** : **OrganisationUnitName** Definition: Organization unit name of the attribute (ASN.1 Object Identifier: id-at-organizationalUnitName).  \\n\\n- ***CATT*** : **CountryName** Definition: Country name of the attribute (ASN.1 Object Identifier: id-at-countryName).   */
    val attrTp: RelativeDistinguishedName1AnyOf.AttrTp,
    val attrVal: AttributeValue1,
    /*  */
...
)
{
    /**
    * Type of attribute of a distinguished name (see X.500). AttributeType\\n\\n- ***CNAT*** : **CommonName** Definition: Common name of the attribute (ASN.1 Object Identifier: id-at-commonName).  \\n\\n- ***LATT*** : **Locality** Definition: Locality of the attribute (ASN.1 Object Identifier: id-at-localityName).  \\n\\n- ***OATT*** : **OrganisationName** Definition: Organization name of the attribute (ASN.1 Object Identifier: id-at-organizationName).  \\n\\n- ***OUAT*** : **OrganisationUnitName** Definition: Organization unit name of the attribute (ASN.1 Object Identifier: id-at-organizationalUnitName).  \\n\\n- ***CATT*** : **CountryName** Definition: Country name of the attribute (ASN.1 Object Identifier: id-at-countryName).  
    * Values: CNAT,LATT,OATT,OUAT,CATT
    */
    enum class AttrTp(val value: kotlin.String){
        CNAT("CNAT"),
        LATT("LATT"),
        OATT("OATT"),
        OUAT("OUAT"),
