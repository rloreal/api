...
/**
 * Specifies the card program actually selected by the cardholder among the ones supported by the retailer and/or the one actually proposed to him. CardProgrammeApplied
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class CardProgrammeApplied1(
