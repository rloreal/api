...
/**
 * Identification, given by the merchant, of the transaction processed with the cardholder that legitimates this merchant initiated transaction. MerchantCITIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class MerchantCITIdentification1(
