...
import com.lorealconsulting.nexoretail.kotlin.models.BalanceRequestAuthorisationResultAuthorisationEntity

import kotlinx.serialization.Serializable
/**
 * Outcome of the authorisation request.
 * @param response Result of the transaction.
 * @param authorisationCode Value assigned by the authorising party.
 * @param authorisationEntity 
 * @param responseReason Detailed result of the transaction.
 * @param additionalResponseInformation Additional information on the response for further examination.
 */
@Serializable
data class BalanceRequestAuthorisationResult(
    /* Result of the transaction. */
    val response: BalanceRequestAuthorisationResult.Response,
    /* Value assigned by the authorising party. */
    val authorisationCode: kotlin.String? = null,
    val authorisationEntity: BalanceRequestAuthorisationResultAuthorisationEntity? = null,
    /* Detailed result of the transaction. */
    val responseReason: kotlin.String? = null,
    /* Additional information on the response for further examination. */
    val additionalResponseInformation: kotlin.String? = null
)
{
    /**
    * Result of the transaction.
