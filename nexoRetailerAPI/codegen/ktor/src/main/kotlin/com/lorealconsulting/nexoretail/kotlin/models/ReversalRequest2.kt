...
import com.lorealconsulting.nexoretail.kotlin.models.CustomerOrder11
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyData1
import com.lorealconsulting.nexoretail.kotlin.models.ReversalTransaction1
import com.lorealconsulting.nexoretail.kotlin.models.ReversedAmount7

import kotlinx.serialization.Serializable
/**
 * Content of the Reversal Request message. ReversalRequest
 * @param rvslRsn Reason for this reversal. ReversalReason\\n\\n- ***CUSC*** : **CustomerCancellation** Definition: Customer cancels the transaction.  \\n\\n- ***MALF*** : **Malfuntion** Definition: Reversal after a suspection of malfunction of the POI system.  \\n\\n- ***MERC*** : **MerchantCancellation** Definition: Merchant or Cashier cancels the transaction.  \\n\\n- ***UNAB*** : **UnableToComplete** Definition: POI System unable to complete transaction.  
 * @param atId 
 * @param cstmrOrdr 
 * @param lltyData 
 * @param rvsdAmt 
 ...
 */
@Serializable
data class ReversalRequest2(
    /* Reason for this reversal. ReversalReason\\n\\n- ***CUSC*** : **CustomerCancellation** Definition: Customer cancels the transaction.  \\n\\n- ***MALF*** : **Malfuntion** Definition: Reversal after a suspection of malfunction of the POI system.  \\n\\n- ***MERC*** : **MerchantCancellation** Definition: Merchant or Cashier cancels the transaction.  \\n\\n- ***UNAB*** : **UnableToComplete** Definition: POI System unable to complete transaction.   */
    val rvslRsn: ReversalRequest2.RvslRsn,
    /*  */
    val atId: kotlin.String? = null,
    val cstmrOrdr: CustomerOrder11? = null,
    val lltyData: LoyaltyData1? = null,
    val rvsdAmt: ReversedAmount7? = null,
    val rvslTx: ReversalTransaction1? = null
)
{
    /**
    * Reason for this reversal. ReversalReason\\n\\n- ***CUSC*** : **CustomerCancellation** Definition: Customer cancels the transaction.  \\n\\n- ***MALF*** : **Malfuntion** Definition: Reversal after a suspection of malfunction of the POI system.  \\n\\n- ***MERC*** : **MerchantCancellation** Definition: Merchant or Cashier cancels the transaction.  \\n\\n- ***UNAB*** : **UnableToComplete** Definition: POI System unable to complete transaction.  
    * Values: CUSC,MALF,MERC,UNAB
    */
    enum class RvslRsn(val value: kotlin.String){
        CUSC("CUSC"),
        MALF("MALF"),
        MERC("MERC"),
        UNAB("UNAB");
