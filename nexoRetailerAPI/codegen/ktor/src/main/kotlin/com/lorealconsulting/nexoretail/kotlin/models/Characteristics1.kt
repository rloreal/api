...
import com.lorealconsulting.nexoretail.kotlin.models.Communication1
import com.lorealconsulting.nexoretail.kotlin.models.Memory1
import com.lorealconsulting.nexoretail.kotlin.models.SecurityElement1

import kotlinx.serialization.Serializable
/**
 * Characteristics of a POI (Point Of Interaction) component. Characteristics
 * @param atId 
 * @param com 
 * @param mmry 
 * @param sbcbrIdntyMdls Number of subscriber identity modules (SIM). SubscriberIdentityModules
 * @param sctyAccsMdls Number of security access modules (SAM). SecurityAccessModules
 * @param sctyElmt 
 */
@Serializable
data class Characteristics1(
    /*  */
    val atId: kotlin.String? = null,
    val com: Communication1? = null,
    val mmry: Memory1? = null,
    /* Number of subscriber identity modules (SIM). SubscriberIdentityModules */
    val sbcbrIdntyMdls: java.math.BigDecimal? = null,
    /* Number of security access modules (SAM). SecurityAccessModules */
    val sctyAccsMdls: java.math.BigDecimal? = null,
    val sctyElmt: SecurityElement1? = null
)
{
}
