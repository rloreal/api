...
import com.lorealconsulting.nexoretail.kotlin.models.ContentEncryptionAlgorithm1

import kotlinx.serialization.Serializable
/**
 * Data protection by encryption (digital envelope), with an encryption key. EncryptedContent
 * @param cnttTp Type of data which have been encrypted. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).  
 * @param ncrptdData Encrypted data, result of the content encryption. EncryptedData
 * @param atId 
 * @param cnttNcrptnAlgo 
 */
@Serializable
data class EncryptedContent1(
    /* Type of data which have been encrypted. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).   */
    val cnttTp: EncryptedContent1.CnttTp,
    /* Encrypted data, result of the content encryption. EncryptedData */
    val ncrptdData: kotlin.String,
    /*  */
    val atId: kotlin.String? = null,
    val cnttNcrptnAlgo: ContentEncryptionAlgorithm1? = null
)
{
    /**
    * Type of data which have been encrypted. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).  
