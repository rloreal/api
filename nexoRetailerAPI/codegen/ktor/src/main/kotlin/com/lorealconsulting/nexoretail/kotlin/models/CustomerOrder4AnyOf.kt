...
import com.lorealconsulting.nexoretail.kotlin.models.AccessedBy
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalInformation
import com.lorealconsulting.nexoretail.kotlin.models.CurrentAmount1
import com.lorealconsulting.nexoretail.kotlin.models.CustomerOrderIdentification
import com.lorealconsulting.nexoretail.kotlin.models.ForecastedAmount1
import com.lorealconsulting.nexoretail.kotlin.models.SaleReferenceIdentification
 ...
 */
@Serializable
data class CustomerOrder4AnyOf(
    val cstmrOrdrId: CustomerOrderIdentification,
    val frcstdAmt: ForecastedAmount1,
    val saleRefId: SaleReferenceIdentification,
    /* Date time of the beginning of an operation. StartDate */
    val startDt: kotlin.String,
    /*  */
    val atId: kotlin.String? = null,
    val accsdBy: AccessedBy? = null,
    val addtlInf: AdditionalInformation? = null,
    /* Currency of monetary amount. Currency */
    val ccy: kotlin.String? = null,
    val curAmt: CurrentAmount1? = null,
    ...
    /* Unit of amount. Unit\\n\\n- ***MONE*** : **Monetary** Definition: The amount is expressed in a monetary value in a currency.  \\n\\n- ***POIN*** : **Point** Definition: The amount is expressed in point.   */
    val unit: CustomerOrder4AnyOf.Unit? = null
)
{
    /**
    * Unit of amount. Unit\\n\\n- ***MONE*** : **Monetary** Definition: The amount is expressed in a monetary value in a currency.  \\n\\n- ***POIN*** : **Point** Definition: The amount is expressed in point.  
