...
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalCardData2
import com.lorealconsulting.nexoretail.kotlin.models.AllowedProduct1
import com.lorealconsulting.nexoretail.kotlin.models.CardBrand1
import com.lorealconsulting.nexoretail.kotlin.models.CardCountryCode1
import com.lorealconsulting.nexoretail.kotlin.models.CardCurrencyCode1
import com.lorealconsulting.nexoretail.kotlin.models.CardProductProfile1
import com.lorealconsulting.nexoretail.kotlin.models.CardProductSubType1
import com.lorealconsulting.nexoretail.kotlin.models.IssuerBIN1
import com.lorealconsulting.nexoretail.kotlin.models.MaskedPAN1
import com.lorealconsulting.nexoretail.kotlin.models.PaymentAccountReference1
import com.lorealconsulting.nexoretail.kotlin.models.PlainCardData1
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedCardData1
import com.lorealconsulting.nexoretail.kotlin.models.ServiceOption1
...
data class Card1(
    ...
    val addtlCardData: AdditionalCardData2? = null,
    val allwdPdct: AllowedProduct1? = null,
    val cardBrnd: CardBrand1? = null,
    val cardCcyCd: CardCurrencyCode1? = null,
    val cardCtryCd: CardCountryCode1? = null,
    val cardPdctPrfl: CardProductProfile1? = null,
    val cardPdctSubTp: CardProductSubType1? = null,
    /* Type of card product. CardProductType\\n\\n- ***COMM*** : **CommercialCard** Definition: Cards issued as a means of business expenditure, for instance business card or corporate card. The user could be a company, an individual for business expenses or a self employed for business purposes.  \\n\\n- ***CONS*** : **ConsumerCard** Definition: Cards issued as a means of personal expenditure. The user is always an individual.   */
    val cardPdctTp: Card1.CardPdctTp? = null,
    /* True if the card may be used abroad. InternationalCard */
    val intrnlCard: kotlin.Boolean? = null,
    val issrBIN: IssuerBIN1? = null,
    val mskdPAN: MaskedPAN1? = null,
    val plainCardData: PlainCardData1? = null,
    val pmtAcctRef: PaymentAccountReference1? = null,
    val prtctdCardData: ProtectedCardData1? = null,
    ...
    val svcOptn: ServiceOption1? = null
)
{
    /**
    * Type of card product. CardProductType\\n\\n- ***COMM*** : **CommercialCard** Definition: Cards issued as a means of business expenditure, for instance business card or corporate card. The user could be a company, an individual for business expenses or a self employed for business purposes.  \\n\\n- ***CONS*** : **ConsumerCard** Definition: Cards issued as a means of personal expenditure. The user is always an individual.  
