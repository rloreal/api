...
import com.lorealconsulting.nexoretail.kotlin.models.AuthenticatedData
import com.lorealconsulting.nexoretail.kotlin.models.DigestedData
import com.lorealconsulting.nexoretail.kotlin.models.EnvelopedData
import com.lorealconsulting.nexoretail.kotlin.models.SignedData
 ...
 */
@Serializable
data class ProtectedComponentWithAuthorisedAccessAnyOf(
    /* Type of data protection. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).   */
    val cnttTp: ProtectedComponentWithAuthorisedAccessAnyOf.CnttTp,
    /*  */
    val atId: kotlin.String? = null,
    val authntcdData: AuthenticatedData? = null,
    val dgstdData: DigestedData? = null,
    val envlpdData: EnvelopedData? = null,
    val sgndData: SignedData? = null
)
{
    /**
    * Type of data protection. ContentType\\n\\n- ***DATA*** : **PlainData** Definition: Generic, non cryptographic, or unqualified data content - (ASN.1 Object Identifier: id-data).  \\n\\n- ***SIGN*** : **SignedData** Definition: Digital signature - (ASN.1 Object Identifier: id-signedData).  \\n\\n- ***EVLP*** : **EnvelopedData** Definition: Encrypted data, with encryption key - (ASN.1 Object Identifier: id-envelopedData).  \\n\\n- ***DGST*** : **DigestedData** Definition: Message digest - (ASN.1 Object Identifier: id-digestedData).  \\n\\n- ***AUTH*** : **AuthenticatedData** Definition: MAC (Message Authentication Code), with encryption key - (ASN.1 Object Identifier: id-ct-authData).  
