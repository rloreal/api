...
/**
 * Balance and currency code of the account, related to the payment. Balance
 * @param amt 
 * @param ccy Currency associated with the transaction. Currency
 * @param atId 
 * @param sgn Indicates that the amount value is positive or negative. Sign
 */
@Serializable
data class Balance7(
    val amt: Amount8,
    /* Currency associated with the transaction. Currency */
    val ccy: kotlin.String,
    /*  */
    val atId: kotlin.String? = null,
    /* Indicates that the amount value is positive or negative. Sign */
    val sgn: kotlin.Boolean? = null
)
{
}
