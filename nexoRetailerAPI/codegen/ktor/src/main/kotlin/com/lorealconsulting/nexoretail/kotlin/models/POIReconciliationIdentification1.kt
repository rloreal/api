...
/**
 * Unique identification of the reconciliation period between the acceptor and the acquirer. POIReconciliationIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class POIReconciliationIdentification1(
