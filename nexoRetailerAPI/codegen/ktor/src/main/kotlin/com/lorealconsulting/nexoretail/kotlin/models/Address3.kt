...
import com.lorealconsulting.nexoretail.kotlin.models.Address3AnyOf
import com.lorealconsulting.nexoretail.kotlin.models.AddressValue1

import kotlinx.serialization.Serializable
/**
 * 
 * @param adrVal 
 * @param ntwkTp Type of communication network. NetworkType\\n\\n- ***IPNW*** : **InternetProtocol** Definition: Protocol of an IP network.  \\n\\n- ***PSTN*** : **PublicTelephone** Definition: Protocol of a Public Switched Telephone Network (PSTN).  
 * @param atId 
 */
@Serializable
data class Address3(
    val adrVal: AddressValue1,
    /* Type of communication network. NetworkType\\n\\n- ***IPNW*** : **InternetProtocol** Definition: Protocol of an IP network.  \\n\\n- ***PSTN*** : **PublicTelephone** Definition: Protocol of a Public Switched Telephone Network (PSTN).   */
    val ntwkTp: Address3.NtwkTp,
    /*  */
...
)
{
    ...
    * Values: IPNW,PSTN
    */
    enum class NtwkTp(val value: kotlin.String){
        IPNW("IPNW"),
        PSTN("PSTN");
    }
}
