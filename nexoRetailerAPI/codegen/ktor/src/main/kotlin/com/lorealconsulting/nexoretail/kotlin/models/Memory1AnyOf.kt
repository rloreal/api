...
import com.lorealconsulting.nexoretail.kotlin.models.Identification25

import kotlinx.serialization.Serializable
/**
 * Memory characteristics of the component. Memory
 * @param freeSz Total size of the available memory. FreeSize
 * @param id 
 * @param ttlSz Total size of the memory unit. TotalSize
 * @param unit Memory unit of the sizes. Unit\\n\\n- ***BYTE*** : **Byte** Definition: Byte.  \\n\\n- ***EXAB*** : **ExaByte** Definition: Exa byte.  \\n\\n- ***GIGA*** : **GigaByte** Definition: Giga byte.  \\n\\n- ***KILO*** : **KiloByte** Definition: Kilo byte.  \\n\\n- ***MEGA*** : **MegaByte** Definition: Mega byte.  \\n\\n- ***PETA*** : **PetaByte** Definition: Peta byte.  \\n\\n- ***TERA*** : **TeraByte** Definition: Tera byte.  
 * @param atId 
 */
@Serializable
data class Memory1AnyOf(
    /* Total size of the available memory. FreeSize */
    val freeSz: java.math.BigDecimal,
    val id: Identification25,
    /* Total size of the memory unit. TotalSize */
    val ttlSz: java.math.BigDecimal,
    /* Memory unit of the sizes. Unit\\n\\n- ***BYTE*** : **Byte** Definition: Byte.  \\n\\n- ***EXAB*** : **ExaByte** Definition: Exa byte.  \\n\\n- ***GIGA*** : **GigaByte** Definition: Giga byte.  \\n\\n- ***KILO*** : **KiloByte** Definition: Kilo byte.  \\n\\n- ***MEGA*** : **MegaByte** Definition: Mega byte.  \\n\\n- ***PETA*** : **PetaByte** Definition: Peta byte.  \\n\\n- ***TERA*** : **TeraByte** Definition: Tera byte.   */
    val unit: Memory1AnyOf.Unit,
    /*  */
...
)
{
    /**
    * Memory unit of the sizes. Unit\\n\\n- ***BYTE*** : **Byte** Definition: Byte.  \\n\\n- ***EXAB*** : **ExaByte** Definition: Exa byte.  \\n\\n- ***GIGA*** : **GigaByte** Definition: Giga byte.  \\n\\n- ***KILO*** : **KiloByte** Definition: Kilo byte.  \\n\\n- ***MEGA*** : **MegaByte** Definition: Mega byte.  \\n\\n- ***PETA*** : **PetaByte** Definition: Peta byte.  \\n\\n- ***TERA*** : **TeraByte** Definition: Tera byte.  
    * Values: BYTE,EXAB,GIGA,KILO,MEGA,PETA,TERA
    */
