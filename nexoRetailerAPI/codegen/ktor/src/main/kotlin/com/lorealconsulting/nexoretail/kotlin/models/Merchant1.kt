...
import com.lorealconsulting.nexoretail.kotlin.models.CommonName3
import com.lorealconsulting.nexoretail.kotlin.models.Identification24
import com.lorealconsulting.nexoretail.kotlin.models.LocationAndContact1
import com.lorealconsulting.nexoretail.kotlin.models.SchemeData1

import kotlinx.serialization.Serializable
/**
 * Merchant performing the card payment transaction.  Usage: In some cases, merchant and acceptor may be regarded as the same entity. Merchant
 * @param atId 
 * @param cmonNm 
 * @param id 
 * @param lctnAndCtct 
 * @param lctnCtgy Location category of the place where the merchant actually performed the transaction. LocationCategory\\n\\n- ***ABRD*** : **Aboard** Definition: Aboard is used when the sale is done in a vehicle (e.g a bus, train, ship, airplane,  taxi, etc).  \\n\\n- ***NMDC*** : **Nomadic** Definition: Nomadic is used when the merchant is traveling to different locations (e.g fair or  sport events, home delivery, food truck).  \\n\\n- ***FIXD*** : **PhysicalShop** Definition: Fixed location, for example in a shop.  \\n\\n- ***VIRT*** : **VirtualShop** Definition: Virtual Shop is used for any ecommerce solution.  
 * @param schmeData 
 */
@Serializable
data class Merchant1(
    ...
    val cmonNm: CommonName3? = null,
    val id: Identification24? = null,
    val lctnAndCtct: LocationAndContact1? = null,
    /* Location category of the place where the merchant actually performed the transaction. LocationCategory\\n\\n- ***ABRD*** : **Aboard** Definition: Aboard is used when the sale is done in a vehicle (e.g a bus, train, ship, airplane,  taxi, etc).  \\n\\n- ***NMDC*** : **Nomadic** Definition: Nomadic is used when the merchant is traveling to different locations (e.g fair or  sport events, home delivery, food truck).  \\n\\n- ***FIXD*** : **PhysicalShop** Definition: Fixed location, for example in a shop.  \\n\\n- ***VIRT*** : **VirtualShop** Definition: Virtual Shop is used for any ecommerce solution.   */
    val lctnCtgy: Merchant1.LctnCtgy? = null,
    val schmeData: SchemeData1? = null
)
{
    /**
    * Location category of the place where the merchant actually performed the transaction. LocationCategory\\n\\n- ***ABRD*** : **Aboard** Definition: Aboard is used when the sale is done in a vehicle (e.g a bus, train, ship, airplane,  taxi, etc).  \\n\\n- ***NMDC*** : **Nomadic** Definition: Nomadic is used when the merchant is traveling to different locations (e.g fair or  sport events, home delivery, food truck).  \\n\\n- ***FIXD*** : **PhysicalShop** Definition: Fixed location, for example in a shop.  \\n\\n- ***VIRT*** : **VirtualShop** Definition: Virtual Shop is used for any ecommerce solution.  
    * Values: ABRD,NMDC,FIXD,VIRT
    */
    enum class LctnCtgy(val value: kotlin.String){
        ABRD("ABRD"),
        NMDC("NMDC"),
        FIXD("FIXD"),
        VIRT("VIRT");
