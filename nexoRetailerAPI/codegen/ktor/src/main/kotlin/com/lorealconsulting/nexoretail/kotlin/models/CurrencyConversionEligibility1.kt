...
import com.lorealconsulting.nexoretail.kotlin.models.ApplicableBinRange1
import com.lorealconsulting.nexoretail.kotlin.models.CommissionDetails3
import com.lorealconsulting.nexoretail.kotlin.models.CurrencyConversionIdentification1
import com.lorealconsulting.nexoretail.kotlin.models.DeclarationDetails1
import com.lorealconsulting.nexoretail.kotlin.models.MarkUpDetails1
import com.lorealconsulting.nexoretail.kotlin.models.OriginalAmount2
import com.lorealconsulting.nexoretail.kotlin.models.ResultingAmount2
import com.lorealconsulting.nexoretail.kotlin.models.SourceCurrency1
import com.lorealconsulting.nexoretail.kotlin.models.TargetCurrency1

import kotlinx.serialization.Serializable
/**
 * Conversion between the currency of a card acceptor and the currency of a card issuer, provided by a dedicated service provider. The currency conversion has to be proposed to the cardholder. CurrencyConversionEligibility
 * @param srcCcy 
 * @param trgtCcy 
 ...
 */
@Serializable
data class CurrencyConversionEligibility1(
    val srcCcy: SourceCurrency1,
    val trgtCcy: TargetCurrency1,
    ...
    val aplblBinRg: ApplicableBinRange1? = null,
    val ccyConvsId: CurrencyConversionIdentification1? = null,
    val comssnDtls: CommissionDetails3? = null,
    val dclrtnDtls: DeclarationDetails1? = null,
    val mrkUpDtls: MarkUpDetails1? = null,
