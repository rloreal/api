 ...
 * @param transactionDateTime Local date and time of the transaction assigned by the POI (Point Of Interaction).
 * @param transactionReference Detailed result of the transaction.
 */
@Serializable
data class BalanceRequestTransactionIdentification(
    /* Local date and time of the transaction assigned by the POI (Point Of Interaction). */
    val transactionDateTime: kotlin.String,
