...
import com.lorealconsulting.nexoretail.kotlin.models.Identification18
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedValue1
import com.lorealconsulting.nexoretail.kotlin.models.Type3

import kotlinx.serialization.Serializable
/**
 * Consecutive slices of the full software package identified through PackageIdentification starting with first slice at the place identified with OffsetStart and ending with the last slice at the previous place identified with OffsetEnd. PackageBlock
 * @param id 
 * @param atId 
 * @param prtctdVal 
 * @param tp 
 * @param `val` Data to exchange according to an external standard. Value
 */
@Serializable
data class PackageBlock1AnyOf(
    val id: Identification18,
    /*  */
    val atId: kotlin.String? = null,
    val prtctdVal: ProtectedValue1? = null,
    val tp: Type3? = null,
    /* Data to exchange according to an external standard. Value */
