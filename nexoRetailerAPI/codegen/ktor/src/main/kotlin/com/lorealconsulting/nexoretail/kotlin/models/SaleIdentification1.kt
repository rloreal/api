...
/**
 * Identification of the sale terminal (electronic cash register or point of sale terminal) or the sale system. SaleIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class SaleIdentification1(
