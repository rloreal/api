...
import com.lorealconsulting.nexoretail.kotlin.models.Capabilities
import com.lorealconsulting.nexoretail.kotlin.models.Component
import com.lorealconsulting.nexoretail.kotlin.models.GroupIdentification
import com.lorealconsulting.nexoretail.kotlin.models.Identification14
import com.lorealconsulting.nexoretail.kotlin.models.SystemName
import com.lorealconsulting.nexoretail.kotlin.models.TimeZone
...
@Serializable
data class POI(
    val id: Identification14,
    /*  */
    val atId: kotlin.String? = null,
    val cmpnt: Component? = null,
    val cpblties: Capabilities? = null,
    val grpId: GroupIdentification? = null,
    val sysNm: SystemName? = null,
    /* Indicates the type of integration of the POI terminal in the sale environment. TerminalIntegration\\n\\n- ***INDR*** : **Indoor** Definition: Indoor terminal.  \\n\\n- ***IPMP*** : **InsidePump** Definition: Terminal incorporated in the pump dispensing petrol.  \\n\\n- ***MPOI*** : **MultiplePOITerminal** Definition: Multiple terminals linked to a unique sale terminal.  \\n\\n- ***MPMP*** : **MultiplePump** Definition: Outdoor terminal serving several petrol pumps.  \\n\\n- ***MSLE*** : **MultipleSaleTerminal** Definition: Terminal serving multiple sale terminals.  \\n\\n- ***SSLE*** : **SingleSaleTerminal** Definition: Terminal linked to a unique sale terminal.  \\n\\n- ***VNDG*** : **VendingMachine** Definition: Terminal integrated in a vending machine.   */
    val termnlIntgtn: POI.TermnlIntgtn? = null,
    val tmZone: TimeZone? = null
)
{
    /**
    * Indicates the type of integration of the POI terminal in the sale environment. TerminalIntegration\\n\\n- ***INDR*** : **Indoor** Definition: Indoor terminal.  \\n\\n- ***IPMP*** : **InsidePump** Definition: Terminal incorporated in the pump dispensing petrol.  \\n\\n- ***MPOI*** : **MultiplePOITerminal** Definition: Multiple terminals linked to a unique sale terminal.  \\n\\n- ***MPMP*** : **MultiplePump** Definition: Outdoor terminal serving several petrol pumps.  \\n\\n- ***MSLE*** : **MultipleSaleTerminal** Definition: Terminal serving multiple sale terminals.  \\n\\n- ***SSLE*** : **SingleSaleTerminal** Definition: Terminal linked to a unique sale terminal.  \\n\\n- ***VNDG*** : **VendingMachine** Definition: Terminal integrated in a vending machine.  
