 ...
 * @param providerIdentification Identifier of the token requestor.
 * @param requestorIdentification Identifier of the token requestor.
 */
@Serializable
data class BalanceRequestCustomerTokenTokenRequestor(
    /* Identifier of the token requestor. */
    val providerIdentification: kotlin.String,
    /* Identifier of the token requestor. */
    val requestorIdentification: kotlin.String
)
{
}
