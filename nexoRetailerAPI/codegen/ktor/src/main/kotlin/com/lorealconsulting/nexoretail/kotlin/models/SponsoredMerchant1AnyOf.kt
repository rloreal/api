...
import com.lorealconsulting.nexoretail.kotlin.models.Address5
import com.lorealconsulting.nexoretail.kotlin.models.CommonName2
import com.lorealconsulting.nexoretail.kotlin.models.MerchantCategoryCode1
import com.lorealconsulting.nexoretail.kotlin.models.RegisteredIdentifier1

import kotlinx.serialization.Serializable
/**
 * Merchant using the payment services of a payment facilitator, acting as a card acceptor. SponsoredMerchant
 * @param cmonNm 
 * @param ctryCd Country of the merchant. CountryCode
 * @param mrchntCtgyCd 
 * @param regdIdr 
 * @param atId 
 * @param adr 
 */
@Serializable
data class SponsoredMerchant1AnyOf(
    val cmonNm: CommonName2,
    /* Country of the merchant. CountryCode */
    val ctryCd: kotlin.String,
    val mrchntCtgyCd: MerchantCategoryCode1,
    val regdIdr: RegisteredIdentifier1,
    /*  */
    val atId: kotlin.String? = null,
    val adr: Address5? = null
)
{
}
