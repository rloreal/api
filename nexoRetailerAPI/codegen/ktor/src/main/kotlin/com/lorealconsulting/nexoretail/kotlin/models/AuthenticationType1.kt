...
/**
 * Type of authentication for a given method - e.g. three-domain authentication, scheme-proprietary authentication, etc. AuthenticationType
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class AuthenticationType1(
