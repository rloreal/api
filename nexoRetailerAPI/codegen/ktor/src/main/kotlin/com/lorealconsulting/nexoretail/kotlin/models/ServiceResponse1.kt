...
import com.lorealconsulting.nexoretail.kotlin.models.BalanceInquiryResponse1
import com.lorealconsulting.nexoretail.kotlin.models.BatchResponse1
import com.lorealconsulting.nexoretail.kotlin.models.CardAcquisitionResponse1
import com.lorealconsulting.nexoretail.kotlin.models.Context2
import com.lorealconsulting.nexoretail.kotlin.models.Environment2
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyResponse1
import com.lorealconsulting.nexoretail.kotlin.models.PaymentResponse1
import com.lorealconsulting.nexoretail.kotlin.models.Response3
import com.lorealconsulting.nexoretail.kotlin.models.ReversalResponse1
import com.lorealconsulting.nexoretail.kotlin.models.StoredValueResponse1
 ...
 */
@Serializable
data class ServiceResponse1(
    val cntxt: Context2,
    val envt: Environment2,
    val rspn: Response3,
    /* Define the type of service response. ServiceContent\\n\\n- ***FSPP*** : **FinancialPaymentResponse** Definition: The POI System sends a response to a payment request (Purchase/refund/PWCB/MOTO Payment/...).  \\n\\n- ***FSRP*** : **FinancialReversalResponse** Definition: The POI System sends a response to a reversal request.  \\n\\n- ***FSIP*** : **FinancialBalanceInquiryResponse** Definition: The POI System sends a response to a Balance Inquiry request.  \\n\\n- ***FSBP*** : **FinancialBatchResponse** Definition: The POI System sends a response to a batch processing request.  \\n\\n- ***FSLP*** : **FinancialLoyaltyResponse** Definition: The POI System sends a response to a loyalty processing request.  \\n\\n- ***FSVP*** : **FinancialStoredValueResponse** Definition: The POI System sends a response to a stored value card or account request.  \\n\\n- ***FSEP*** : **FinancialEnableServiceResponse** Definition: The POI System sends a response after enabling or not some service.  \\n\\n- ***FSAP*** : **FinancialCardAcquisitionResponse** Definition: The POI System sends a response to a card data acquisition request.  \\n\\n- ***FSCP*** : **FinancialReconciliationResponse** Definition: The POI System sends a response to a reconciliation request.   */
    val svcCntt: ServiceResponse1.SvcCntt,
    /*  */
    val atId: kotlin.String? = null,
    val balNqryRspn: BalanceInquiryResponse1? = null,
    val btchRspn: BatchResponse1? = null,
    val cardAcqstnRspn: CardAcquisitionResponse1? = null,
    val lltyRspn: LoyaltyResponse1? = null,
    val pmtRspn: PaymentResponse1? = null,
    val rvslRspn: ReversalResponse1? = null,
    val splmtryData: SupplementaryData1? = null,
    val stordValRspn: StoredValueResponse1? = null
)
{
    /**
    * Define the type of service response. ServiceContent\\n\\n- ***FSPP*** : **FinancialPaymentResponse** Definition: The POI System sends a response to a payment request (Purchase/refund/PWCB/MOTO Payment/...).  \\n\\n- ***FSRP*** : **FinancialReversalResponse** Definition: The POI System sends a response to a reversal request.  \\n\\n- ***FSIP*** : **FinancialBalanceInquiryResponse** Definition: The POI System sends a response to a Balance Inquiry request.  \\n\\n- ***FSBP*** : **FinancialBatchResponse** Definition: The POI System sends a response to a batch processing request.  \\n\\n- ***FSLP*** : **FinancialLoyaltyResponse** Definition: The POI System sends a response to a loyalty processing request.  \\n\\n- ***FSVP*** : **FinancialStoredValueResponse** Definition: The POI System sends a response to a stored value card or account request.  \\n\\n- ***FSEP*** : **FinancialEnableServiceResponse** Definition: The POI System sends a response after enabling or not some service.  \\n\\n- ***FSAP*** : **FinancialCardAcquisitionResponse** Definition: The POI System sends a response to a card data acquisition request.  \\n\\n- ***FSCP*** : **FinancialReconciliationResponse** Definition: The POI System sends a response to a reconciliation request.  
