...
import com.lorealconsulting.nexoretail.kotlin.models.Conversion4

import kotlinx.serialization.Serializable
/**
 * Result of the currency conversion proposed to the cardholder. CurrencyConversionResult
 * @param atId 
 * @param accptdByCrdhldr True if the cardholder has accepted the currency conversion that the acquirer has proposed. AcceptedByCardholder
 * @param convs 
 */
@Serializable
data class CurrencyConversionResult4(
    /*  */
    val atId: kotlin.String? = null,
    /* True if the cardholder has accepted the currency conversion that the acquirer has proposed. AcceptedByCardholder */
    val accptdByCrdhldr: kotlin.Boolean? = null,
    val convs: Conversion4? = null
)
{
}
