...
/**
 * Hierarchical identification of a key inside all the key system. It is composed of all item numbers of the upper level components, separated by the '.' character, ended by the item number of the current component. ItemNumber
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class ItemNumber2(
