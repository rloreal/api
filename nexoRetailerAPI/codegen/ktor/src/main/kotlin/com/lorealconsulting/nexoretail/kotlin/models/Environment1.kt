...
import com.lorealconsulting.nexoretail.kotlin.models.Acquirer
import com.lorealconsulting.nexoretail.kotlin.models.Card
import com.lorealconsulting.nexoretail.kotlin.models.Cardholder
import com.lorealconsulting.nexoretail.kotlin.models.Check
import com.lorealconsulting.nexoretail.kotlin.models.CustomerDevice
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyAccount
import com.lorealconsulting.nexoretail.kotlin.models.Merchant
import com.lorealconsulting.nexoretail.kotlin.models.MerchantToken
import com.lorealconsulting.nexoretail.kotlin.models.POI
import com.lorealconsulting.nexoretail.kotlin.models.PaymentToken
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedCardholderData
import com.lorealconsulting.nexoretail.kotlin.models.SaleEnvironment1
import com.lorealconsulting.nexoretail.kotlin.models.ServiceProvider
import com.lorealconsulting.nexoretail.kotlin.models.StoredValueAccount
import com.lorealconsulting.nexoretail.kotlin.models.Wallet
 ...
 */
@Serializable
data class Environment1(
    /*  */
    val atId: kotlin.String? = null,
    val acqrr: Acquirer? = null,
    val card: Card? = null,
    val chck: Check? = null,
    val crdhldr: Cardholder? = null,
    val cstmrDvc: CustomerDevice? = null,
    val lltyAcct: LoyaltyAccount? = null,
    val mrchnt: Merchant? = null,
    val mrchntTkn: MerchantToken? = null,
    val POI: POI? = null,
    val pmtTkn: PaymentToken? = null,
    val prtctdCrdhldrData: ProtectedCardholderData? = null,
    val saleEnvt: SaleEnvironment1? = null,
    val stordValAcct: StoredValueAccount? = null,
    val svcPrvdr: ServiceProvider? = null,
    val wllt: Wallet? = null
)
{
}
