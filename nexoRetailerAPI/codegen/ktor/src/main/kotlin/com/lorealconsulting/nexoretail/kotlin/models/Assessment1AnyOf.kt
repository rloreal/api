...
import com.lorealconsulting.nexoretail.kotlin.models.Assigner1
import com.lorealconsulting.nexoretail.kotlin.models.Number1

import kotlinx.serialization.Serializable
/**
 * Assessments for the component of the point of interaction. Assessment
 * @param assgnr 
 * @param nb 
 * @param tp Type of assessment of the component. Type\\n\\n- ***APPL*** : **Approval** Definition: Approval number delivered by an approval centre.  \\n\\n- ***CERT*** : **Certification** Definition: Certification number delivered by a certification body.  \\n\\n- ***EVAL*** : **Evaluation** Definition: Evaluation by a lab or a tool.  
 * @param atId 
 * @param dlvryDt Date when the assessment has been delivered. DeliveryDate
 * @param xprtnDt Date when the assessment will expire. ExpirationDate
 */
@Serializable
data class Assessment1AnyOf(
    val assgnr: Assigner1,
    val nb: Number1,
    /* Type of assessment of the component. Type\\n\\n- ***APPL*** : **Approval** Definition: Approval number delivered by an approval centre.  \\n\\n- ***CERT*** : **Certification** Definition: Certification number delivered by a certification body.  \\n\\n- ***EVAL*** : **Evaluation** Definition: Evaluation by a lab or a tool.   */
    val tp: Assessment1AnyOf.Tp,
    /*  */
    val atId: kotlin.String? = null,
    /* Date when the assessment has been delivered. DeliveryDate */
    val dlvryDt: kotlin.String? = null,
    /* Date when the assessment will expire. ExpirationDate */
    val xprtnDt: kotlin.String? = null
)
{
    /**
    * Type of assessment of the component. Type\\n\\n- ***APPL*** : **Approval** Definition: Approval number delivered by an approval centre.  \\n\\n- ***CERT*** : **Certification** Definition: Certification number delivered by a certification body.  \\n\\n- ***EVAL*** : **Evaluation** Definition: Evaluation by a lab or a tool.  
    * Values: APPL,CERT,EVAL
    */
