...
import com.lorealconsulting.nexoretail.kotlin.models.GracePeriod1AnyOf
import com.lorealconsulting.nexoretail.kotlin.models.OtherUnitType1
import com.lorealconsulting.nexoretail.kotlin.models.Time1

import kotlinx.serialization.Serializable
/**
 * 
 * @param tm 
 * @param unitTp Grace period unit type. UnitType\\n\\n- ***WEKS*** : **Weeks** Definition: Grace period weeks.  \\n\\n- ***PMTS*** : **Payments** Definition: Grace period payments.  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: Other Private Grace period.  \\n\\n- ***OTHN*** : **OtherNational** Definition: Other National Grace period.  \\n\\n- ***MNTH*** : **Months** Definition: Grace period months.  \\n\\n- ***DAYS*** : **Days** Definition: Grace period days.  
 * @param atId 
 * @param othrUnitTp 
 */
@Serializable
data class GracePeriod1(
    val tm: Time1,
    /* Grace period unit type. UnitType\\n\\n- ***WEKS*** : **Weeks** Definition: Grace period weeks.  \\n\\n- ***PMTS*** : **Payments** Definition: Grace period payments.  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: Other Private Grace period.  \\n\\n- ***OTHN*** : **OtherNational** Definition: Other National Grace period.  \\n\\n- ***MNTH*** : **Months** Definition: Grace period months.  \\n\\n- ***DAYS*** : **Days** Definition: Grace period days.   */
    val unitTp: GracePeriod1.UnitTp,
    /*  */
    val atId: kotlin.String? = null,
    val othrUnitTp: OtherUnitType1? = null
)
{
    /**
    * Grace period unit type. UnitType\\n\\n- ***WEKS*** : **Weeks** Definition: Grace period weeks.  \\n\\n- ***PMTS*** : **Payments** Definition: Grace period payments.  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: Other Private Grace period.  \\n\\n- ***OTHN*** : **OtherNational** Definition: Other National Grace period.  \\n\\n- ***MNTH*** : **Months** Definition: Grace period months.  \\n\\n- ***DAYS*** : **Days** Definition: Grace period days.  
    * Values: WEKS,PMTS,OTHP,OTHN,MNTH,DAYS
    */
    enum class UnitTp(val value: kotlin.String){
        WEKS("WEKS"),
        PMTS("PMTS"),
        OTHP("OTHP"),
        OTHN("OTHN"),
