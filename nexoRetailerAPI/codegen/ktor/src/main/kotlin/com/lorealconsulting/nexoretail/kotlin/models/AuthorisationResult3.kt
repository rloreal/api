...
import com.lorealconsulting.nexoretail.kotlin.models.AuthorisationCode1
import com.lorealconsulting.nexoretail.kotlin.models.AuthorisationEntity1
import com.lorealconsulting.nexoretail.kotlin.models.ResponseToAuthorisation1
import com.lorealconsulting.nexoretail.kotlin.models.TMSTrigger1

import kotlinx.serialization.Serializable
/**
 * Outcome of the authorisation, and actions to perform. AuthorisationResult
 * @param rspnToAuthstn 
 * @param atId 
 * @param authstnCd 
 * @param authstnNtty 
 * @param cmpltnReqrd Indicates whether the acquirer requires a further exchange completion after the completion of the transaction. CompletionRequired
 * @param tmSTrggr 
 */
@Serializable
data class AuthorisationResult3(
    val rspnToAuthstn: ResponseToAuthorisation1,
    /*  */
    val atId: kotlin.String? = null,
    val authstnCd: AuthorisationCode1? = null,
    val authstnNtty: AuthorisationEntity1? = null,
    /* Indicates whether the acquirer requires a further exchange completion after the completion of the transaction. CompletionRequired */
    val cmpltnReqrd: kotlin.Boolean? = null,
    val tmSTrggr: TMSTrigger1? = null
)
{
}
