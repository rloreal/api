...
import com.lorealconsulting.nexoretail.kotlin.models.Name6
import com.lorealconsulting.nexoretail.kotlin.models.NumericCode1

import kotlinx.serialization.Serializable
/**
 * Currency from which the amount is converted (ISO 4217, 3 alphanumeric characters). SourceCurrency
 * @param atId 
 * @param alphaCd Alpha currency code (ISO 4217, 3 alphanumeric characters). AlphaCode
 * @param dcml Maximal number of digits after the decimal separator for the currency. Decimal
 * @param nm 
 * @param nmrcCd 
 */
@Serializable
data class SourceCurrency1(
    /*  */
    val atId: kotlin.String? = null,
    /* Alpha currency code (ISO 4217, 3 alphanumeric characters). AlphaCode */
    val alphaCd: kotlin.String? = null,
    /* Maximal number of digits after the decimal separator for the currency. Decimal */
    val dcml: java.math.BigDecimal? = null,
    val nm: Name6? = null,
    val nmrcCd: NumericCode1? = null
)
{
}
