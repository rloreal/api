...
/**
 * Reference assigned to a creditor by its financial institution, or relevant authority, authorising the creditor to take part in a direct debit scheme. RegistrationIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class RegistrationIdentification1(
