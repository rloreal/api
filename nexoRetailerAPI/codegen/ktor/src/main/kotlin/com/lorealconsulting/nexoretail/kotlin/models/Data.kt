...
import com.lorealconsulting.nexoretail.kotlin.models.AccountIdentification
import com.lorealconsulting.nexoretail.kotlin.models.DataAnyOf
import com.lorealconsulting.nexoretail.kotlin.models.DataAnyOf1Inner
import com.lorealconsulting.nexoretail.kotlin.models.EANUPC
import com.lorealconsulting.nexoretail.kotlin.models.HostTransactionIdentification
import com.lorealconsulting.nexoretail.kotlin.models.ItemAmount
import com.lorealconsulting.nexoretail.kotlin.models.OriginalPOITransaction
import com.lorealconsulting.nexoretail.kotlin.models.ProductCode1
import com.lorealconsulting.nexoretail.kotlin.models.Provider2
...
data class Data(
    ...
    val acctId: AccountIdentification? = null,
    /* Currency of the monetary amount. Currency */
    val ccy: kotlin.String? = null,
    val EANUPC: EANUPC? = null,
    val hstTxId: HostTransactionIdentification? = null,
    val itmAmt: ItemAmount? = null,
    val orgnlPOITx: OriginalPOITransaction? = null,
    val pdctCd: ProductCode1? = null,
    val prvdr: Provider2? = null
)
{
    /**
    * Identification of operation to proceed on the stored value account or the stored value card. TransactionType\\n\\n- ***ACTV*** : **Activate** Definition: Activate the account or the card.  \\n\\n- ***DUPL*** : **Duplicate** Definition: Duplicate the code or number provided by the loading or activation.  \\n\\n- ***LOAD*** : **Load** Definition: Load the account or the card with money.  \\n\\n- ***RESV*** : **Reserve** Definition: Reserve the account (e.g. get an activation code).  \\n\\n- ***REVS*** : **Reverse** Definition: Reverse an activation or loading.  \\n\\n- ***ULOA*** : **Unload** Definition: Unload the account.  \\n\\n- ***CLOS*** : **CloseAccount** Definition: Close the account.  \\n\\n- ***DCTV*** : **Deactivate** Definition: Deactivate the account or the card.  \\n\\n- ***OPEN*** : **OpenAccount** Definition: Open the account.  \\n\\n- ***BALC*** : **Balance** Definition: Balance enquiry.  
