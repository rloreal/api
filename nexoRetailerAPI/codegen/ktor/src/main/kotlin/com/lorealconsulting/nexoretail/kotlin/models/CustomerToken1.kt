...
import com.lorealconsulting.nexoretail.kotlin.models.CardSequenceNumber2
import com.lorealconsulting.nexoretail.kotlin.models.Token2
import com.lorealconsulting.nexoretail.kotlin.models.TokenAssuranceMethod1
import com.lorealconsulting.nexoretail.kotlin.models.TokenCharacteristic1
import com.lorealconsulting.nexoretail.kotlin.models.TokenExpiryDate2
import com.lorealconsulting.nexoretail.kotlin.models.TokenRequestor1

import kotlinx.serialization.Serializable
/**
 * Customer payment token information. CustomerToken
 * @param atId 
 * @param cardSeqNb 
 * @param tkn 
 * @param tknAssrncData Information about the identification and verification of the cardholder. TokenAssuranceData
 * @param tknAssrncLvl Level of confidence resulting of the identification and authentication of the cardholder performed and the entity that performed it. TokenAssuranceLevel
 * @param tknAssrncMtd 
 * @param tknChrtc 
 * @param tknInittdInd Original transaction was initiated by Token. TokenInitiatedIndicator
 * @param tknRqstr 
 * @param tknXpryDt 
 */
@Serializable
data class CustomerToken1(
    /*  */
    val atId: kotlin.String? = null,
    val cardSeqNb: CardSequenceNumber2? = null,
    val tkn: Token2? = null,
    /* Information about the identification and verification of the cardholder. TokenAssuranceData */
    val tknAssrncData: kotlin.String? = null,
    /* Level of confidence resulting of the identification and authentication of the cardholder performed and the entity that performed it. TokenAssuranceLevel */
    val tknAssrncLvl: java.math.BigDecimal? = null,
    val tknAssrncMtd: TokenAssuranceMethod1? = null,
    val tknChrtc: TokenCharacteristic1? = null,
    /* Original transaction was initiated by Token. TokenInitiatedIndicator */
    val tknInittdInd: kotlin.Boolean? = null,
    val tknRqstr: TokenRequestor1? = null,
    val tknXpryDt: TokenExpiryDate2? = null
)
{
}
