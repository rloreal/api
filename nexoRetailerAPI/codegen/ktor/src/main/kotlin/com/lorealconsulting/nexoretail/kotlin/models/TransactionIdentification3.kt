...
import com.lorealconsulting.nexoretail.kotlin.models.TransactionReference1

import kotlinx.serialization.Serializable
/**
 * Identification of the transaction assigned by the initiator of the request. For instance refers to POITransactionIdentification if used inside an authorisation request or to SaleTransactionIdentification if the message is a payment request initiated by a sale system. TransactionIdentification
 * @param txDtTm Local date and time of the transaction assigned by the POI (Point Of Interaction). TransactionDateTime
 * @param txRef 
 * @param atId 
 */
@Serializable
data class TransactionIdentification3(
    /* Local date and time of the transaction assigned by the POI (Point Of Interaction). TransactionDateTime */
    val txDtTm: kotlin.String,
    val txRef: TransactionReference1,
    /*  */
