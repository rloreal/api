...
/**
 * Specifies the card program proposed by a retailer to a cardholder among a series of payment programmes offered by the retailer. CardProgrammeProposed
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class CardProgrammeProposed1AnyOf(
