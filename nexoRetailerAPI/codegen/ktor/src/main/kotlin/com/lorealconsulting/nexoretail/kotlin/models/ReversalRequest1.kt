...
import com.lorealconsulting.nexoretail.kotlin.models.CustomerOrder3
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyData
import com.lorealconsulting.nexoretail.kotlin.models.ReversalTransaction
import com.lorealconsulting.nexoretail.kotlin.models.ReversedAmount
 ...
 */
@Serializable
data class ReversalRequest1(
    /* Reason for this reversal. ReversalReason\\n\\n- ***CUSC*** : **CustomerCancellation** Definition: Customer cancels the transaction.  \\n\\n- ***MALF*** : **Malfuntion** Definition: Reversal after a suspection of malfunction of the POI system.  \\n\\n- ***MERC*** : **MerchantCancellation** Definition: Merchant or Cashier cancels the transaction.  \\n\\n- ***UNAB*** : **UnableToComplete** Definition: POI System unable to complete transaction.   */
    val rvslRsn: ReversalRequest1.RvslRsn,
    /*  */
    val atId: kotlin.String? = null,
    val cstmrOrdr: CustomerOrder3? = null,
    val lltyData: LoyaltyData? = null,
    val rvsdAmt: ReversedAmount? = null,
    val rvslTx: ReversalTransaction? = null
)
{
    /**
    * Reason for this reversal. ReversalReason\\n\\n- ***CUSC*** : **CustomerCancellation** Definition: Customer cancels the transaction.  \\n\\n- ***MALF*** : **Malfuntion** Definition: Reversal after a suspection of malfunction of the POI system.  \\n\\n- ***MERC*** : **MerchantCancellation** Definition: Merchant or Cashier cancels the transaction.  \\n\\n- ***UNAB*** : **UnableToComplete** Definition: POI System unable to complete transaction.  
