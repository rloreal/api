...
import com.lorealconsulting.nexoretail.kotlin.models.Header1
import com.lorealconsulting.nexoretail.kotlin.models.SecurityTrailer1
import com.lorealconsulting.nexoretail.kotlin.models.ServiceResponse

import kotlinx.serialization.Serializable
/**
 * The SaleToPOIServiceResponse message is sent by a POI to provide the outcome of a financial service. SaleToPOIServiceResponseV06
 * @param hdr 
 * @param svcRspn 
 * @param atMinorVersion 
 * @param sctyTrlr 
 */
@Serializable
data class CreateFinancialService201Response(
    val hdr: Header1,
    val svcRspn: ServiceResponse,
    /*  */
    val atMinorVersion: kotlin.collections.List<kotlin.String>? = null,
    val sctyTrlr: SecurityTrailer1? = null
)
{
}
