...
import com.lorealconsulting.nexoretail.kotlin.models.Acquirer1
import com.lorealconsulting.nexoretail.kotlin.models.Card1
import com.lorealconsulting.nexoretail.kotlin.models.Cardholder1
import com.lorealconsulting.nexoretail.kotlin.models.Check1
import com.lorealconsulting.nexoretail.kotlin.models.CustomerDevice1
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyAccount5
import com.lorealconsulting.nexoretail.kotlin.models.Merchant1
import com.lorealconsulting.nexoretail.kotlin.models.MerchantToken1
import com.lorealconsulting.nexoretail.kotlin.models.POI1
import com.lorealconsulting.nexoretail.kotlin.models.PaymentToken1
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedCardholderData1
import com.lorealconsulting.nexoretail.kotlin.models.SaleEnvironment3
import com.lorealconsulting.nexoretail.kotlin.models.ServiceProvider1
import com.lorealconsulting.nexoretail.kotlin.models.StoredValueAccount3
import com.lorealconsulting.nexoretail.kotlin.models.Wallet1

import kotlinx.serialization.Serializable
/**
 * Environment of the transaction. Environment
 * @param atId 
 * @param acqrr 
 * @param card 
 * @param chck 
 ...
 */
@Serializable
data class Environment3(
    /*  */
    val atId: kotlin.String? = null,
    val acqrr: Acquirer1? = null,
    val card: Card1? = null,
    val chck: Check1? = null,
    val crdhldr: Cardholder1? = null,
    val cstmrDvc: CustomerDevice1? = null,
    val lltyAcct: LoyaltyAccount5? = null,
    val mrchnt: Merchant1? = null,
    val mrchntTkn: MerchantToken1? = null,
    val POI: POI1? = null,
    val pmtTkn: PaymentToken1? = null,
    val prtctdCrdhldrData: ProtectedCardholderData1? = null,
    val saleEnvt: SaleEnvironment3? = null,
    val stordValAcct: StoredValueAccount3? = null,
    val svcPrvdr: ServiceProvider1? = null,
    val wllt: Wallet1? = null
)
{
}
