...
import com.lorealconsulting.nexoretail.kotlin.models.Amount12
import com.lorealconsulting.nexoretail.kotlin.models.DetailedCharges2AnyOf
import com.lorealconsulting.nexoretail.kotlin.models.DetailedCharges2AnyOf1Inner
import com.lorealconsulting.nexoretail.kotlin.models.OtherType2
import com.lorealconsulting.nexoretail.kotlin.models.SubType1
 ...
 * @param amt 
 * @param othrTp 
 * @param pctg Rate expressed as a percentage, that is, in hundredths, example, 0.7 is 7/10 of a percent, and 7.0 is 7%. Percentage
 * @param subTp 
 * @param tp Grace period unit type. Type\\n\\n- ***TAXX*** : **Tax** Definition: Instalment amount tax  \\n\\n- ***RQST*** : **Requested** Definition: Requested amount  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: Grace period unit type  \\n\\n- ***OTHN*** : **OtherNational** Definition: Grace period unit type  \\n\\n- ***OTHC*** : **OtherCharges** Definition: Other amounts  \\n\\n- ***INSU*** : **Insurance** Definition: Insurance amount  \\n\\n- ***FUNA*** : **Funded** Definition: Funded amount  \\n\\n- ***FEES*** : **Fees** Definition: Fees amount  \\n\\n- ***EXPN*** : **Expense** Definition: Expense Amount  \\n\\n- ***AFCO*** : **AnnualFinancingCost** Definition: Total financing cost per annum.  
 */
@Serializable
data class DetailedCharges2(
    /*  */
    val atId: kotlin.String? = null,
    val amt: Amount12? = null,
    val othrTp: OtherType2? = null,
    /* Rate expressed as a percentage, that is, in hundredths, example, 0.7 is 7/10 of a percent, and 7.0 is 7%. Percentage */
    val pctg: java.math.BigDecimal? = null,
    val subTp: SubType1? = null,
    /* Grace period unit type. Type\\n\\n- ***TAXX*** : **Tax** Definition: Instalment amount tax  \\n\\n- ***RQST*** : **Requested** Definition: Requested amount  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: Grace period unit type  \\n\\n- ***OTHN*** : **OtherNational** Definition: Grace period unit type  \\n\\n- ***OTHC*** : **OtherCharges** Definition: Other amounts  \\n\\n- ***INSU*** : **Insurance** Definition: Insurance amount  \\n\\n- ***FUNA*** : **Funded** Definition: Funded amount  \\n\\n- ***FEES*** : **Fees** Definition: Fees amount  \\n\\n- ***EXPN*** : **Expense** Definition: Expense Amount  \\n\\n- ***AFCO*** : **AnnualFinancingCost** Definition: Total financing cost per annum.   */
    val tp: DetailedCharges2.Tp? = null
)
{
    /**
    * Grace period unit type. Type\\n\\n- ***TAXX*** : **Tax** Definition: Instalment amount tax  \\n\\n- ***RQST*** : **Requested** Definition: Requested amount  \\n\\n- ***OTHP*** : **OtherPrivate** Definition: Grace period unit type  \\n\\n- ***OTHN*** : **OtherNational** Definition: Grace period unit type  \\n\\n- ***OTHC*** : **OtherCharges** Definition: Other amounts  \\n\\n- ***INSU*** : **Insurance** Definition: Insurance amount  \\n\\n- ***FUNA*** : **Funded** Definition: Funded amount  \\n\\n- ***FEES*** : **Fees** Definition: Fees amount  \\n\\n- ***EXPN*** : **Expense** Definition: Expense Amount  \\n\\n- ***AFCO*** : **AnnualFinancingCost** Definition: Total financing cost per annum.  
    * Values: TAXX,RQST,OTHP,OTHN,OTHC,INSU,FUNA,FEES,EXPN,AFCO
    */
