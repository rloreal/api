...
import com.lorealconsulting.nexoretail.kotlin.models.LoyaltyResult
import com.lorealconsulting.nexoretail.kotlin.models.POIReconciliationIdentification
import com.lorealconsulting.nexoretail.kotlin.models.POITransactionIdentification1
import com.lorealconsulting.nexoretail.kotlin.models.PaymentResult
import com.lorealconsulting.nexoretail.kotlin.models.PerformedTransactionAnyOf
import com.lorealconsulting.nexoretail.kotlin.models.PerformedTransactionAnyOf1Inner
import com.lorealconsulting.nexoretail.kotlin.models.Response
import com.lorealconsulting.nexoretail.kotlin.models.ReversedAmount1
import com.lorealconsulting.nexoretail.kotlin.models.SaleTransactionIdentification1
...
data class PerformedTransaction(
    ...
    val lltyRslt: LoyaltyResult? = null,
    val poIRcncltnId: POIReconciliationIdentification? = null,
    val poITxId: POITransactionIdentification1? = null,
    val pmtRslt: PaymentResult? = null,
    val rvsdAmt: ReversedAmount1? = null,
    val saleTxId: SaleTransactionIdentification1? = null
)
{
}
