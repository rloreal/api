...
import com.lorealconsulting.nexoretail.kotlin.models.AdditionalManagementInformation
import com.lorealconsulting.nexoretail.kotlin.models.ComponentWithAuthorisedAccess
import com.lorealconsulting.nexoretail.kotlin.models.Function
import com.lorealconsulting.nexoretail.kotlin.models.Identification12
import com.lorealconsulting.nexoretail.kotlin.models.ItemNumber
import com.lorealconsulting.nexoretail.kotlin.models.KeyValue
import com.lorealconsulting.nexoretail.kotlin.models.Name4
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedComponentWithAuthorisedAccess
import com.lorealconsulting.nexoretail.kotlin.models.SecurityProfile2
import com.lorealconsulting.nexoretail.kotlin.models.Version

import kotlinx.serialization.Serializable
/**
 * Security characteristics of the component. SecurityElement
 * @param id 
 * @param vrsn 
 * @param atId 
 ...
 */
@Serializable
data class SecurityElementAnyOf(
    val id: Identification12,
    val vrsn: Version,
    /*  */
    ...
    val addtlMgmtInf: AdditionalManagementInformation? = null,
    val cmpntWthAuthrsdAccs: ComponentWithAuthorisedAccess? = null,
    /* Date and time on which the key must be deactivated. DeactivationDate */
    val deactvtnDt: kotlin.String? = null,
    val fctn: Function? = null,
    val itmNb: ItemNumber? = null,
    /* Value for checking a cryptographic key security parameter. KeyCheckValue */
    val keyChckVal: kotlin.String? = null,
    val keyVal: KeyValue? = null,
    val nm: Name4? = null,
    val prtctdCmpntWthAuthrsdAccs: ProtectedComponentWithAuthorisedAccess? = null,
    val sctyPrfl: SecurityProfile2? = null,
    /* Type of algorithm used by the cryptographic key. Type\\n\\n- ***AES2*** : **AES128** Definition: AES (Advanced Encryption Standard) 128 bits cryptographic key as defined by the Federal Information Processing Standards (FIPS 197 - November 6, 2001 - Advanced Encryption Standard).  \\n\\n- ***EDE3*** : **DES112** Definition: Data encryption standard key of 112 bits (without the parity bits).  \\n\\n- ***DKP9*** : **DUKPT2009** Definition: DUKPT (Derived Unique Key Per Transaction) key, as specified in ANSI X9.24-2009 Annex A.  \\n\\n- ***AES9*** : **AES192** Definition: AES (Advanced Encryption Standard) encryption with a 192 bits cryptographic key as defined by the Federal Information Processing Standards (FIPS 197 – November 6, 2001 - Advanced Encryption Standard).  \\n\\n- ***AES5*** : **AES256** Definition: AES (Advanced Encryption Standard) encryption with a 256 bits cryptographic key as defined by the Federal Information Processing Standards (FIPS 197 – November 6, 2001 - Advanced Encryption Standard).  \\n\\n- ***EDE4*** : **DES168** Definition: Data encryption standard key of 168 bits (without the parity bits).   */
    val tp: SecurityElementAnyOf.Tp? = null
)
{
    /**
    * Type of algorithm used by the cryptographic key. Type\\n\\n- ***AES2*** : **AES128** Definition: AES (Advanced Encryption Standard) 128 bits cryptographic key as defined by the Federal Information Processing Standards (FIPS 197 - November 6, 2001 - Advanced Encryption Standard).  \\n\\n- ***EDE3*** : **DES112** Definition: Data encryption standard key of 112 bits (without the parity bits).  \\n\\n- ***DKP9*** : **DUKPT2009** Definition: DUKPT (Derived Unique Key Per Transaction) key, as specified in ANSI X9.24-2009 Annex A.  \\n\\n- ***AES9*** : **AES192** Definition: AES (Advanced Encryption Standard) encryption with a 192 bits cryptographic key as defined by the Federal Information Processing Standards (FIPS 197 – November 6, 2001 - Advanced Encryption Standard).  \\n\\n- ***AES5*** : **AES256** Definition: AES (Advanced Encryption Standard) encryption with a 256 bits cryptographic key as defined by the Federal Information Processing Standards (FIPS 197 – November 6, 2001 - Advanced Encryption Standard).  \\n\\n- ***EDE4*** : **DES168** Definition: Data encryption standard key of 168 bits (without the parity bits).  
