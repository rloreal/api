...
/**
 * Identification of the POI (Point Of Interaction) for the acquirer or its agent. Identification
 * @param id 
 * @param atId 
 * @param ctry 
 * @param glctn 
