...
/**
 * Identification of the acquirer (for example the bank identification number BIN). Identification
 * @param id 
 * @param atId 
 * @param ctry 
 * @param glctn 
