...
/**
 * Additional information used to facilitate contact with the card acceptor, for instance sales agent name, dispute manager name. AdditionalContactInformation
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class AdditionalContactInformation1(
