...
/**
 * Unique reference to the card, used by both merchants and acquirers to link tokenized and non-tokenized transactions associated to the same underlying card. PaymentAccountReference
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class PaymentAccountReference1(
