...
import com.lorealconsulting.nexoretail.kotlin.models.Geolocation1
import com.lorealconsulting.nexoretail.kotlin.models.MobileCountryCode
import com.lorealconsulting.nexoretail.kotlin.models.MobileMaskedMSISDN
import com.lorealconsulting.nexoretail.kotlin.models.MobileNetworkCode
import com.lorealconsulting.nexoretail.kotlin.models.ProtectedMobileData
import com.lorealconsulting.nexoretail.kotlin.models.SensitiveMobileData
 ...
 */
@Serializable
data class MobileDataAnyOf(
    /*  */
    val atId: kotlin.String? = null,
    val glctn: Geolocation1? = null,
    val mobCtryCd: MobileCountryCode? = null,
    val mobMskdMSISDN: MobileMaskedMSISDN? = null,
    val mobNtwkCd: MobileNetworkCode? = null,
    val prtctdMobData: ProtectedMobileData? = null,
    val snstvMobData: SensitiveMobileData? = null
)
{
}
