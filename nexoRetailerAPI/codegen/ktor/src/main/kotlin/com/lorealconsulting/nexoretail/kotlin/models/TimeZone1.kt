...
/**
 * Time zone name as defined by IANA (Internet Assigned Numbers Authority) in the time zone data base. America/Chicago or Europe/Paris are examples of time zone names. TimeZone
 * @param `value` 
 * @param atLang 
 */
@Serializable
