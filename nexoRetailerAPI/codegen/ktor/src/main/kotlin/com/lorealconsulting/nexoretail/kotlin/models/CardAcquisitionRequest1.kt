...
import com.lorealconsulting.nexoretail.kotlin.models.AllowedLoyaltyBrand1
import com.lorealconsulting.nexoretail.kotlin.models.AllowedPaymentBrand1
...
import com.lorealconsulting.nexoretail.kotlin.models.SaleToPOIData3
import com.lorealconsulting.nexoretail.kotlin.models.SaleTransactionIdentification2
import com.lorealconsulting.nexoretail.kotlin.models.TotalAmount13
 ...
 */
@Serializable
data class CardAcquisitionRequest1(
    /*  */
    val atId: kotlin.String? = null,
    val allwdLltyBrnd: AllowedLoyaltyBrand1? = null,
    val allwdPmtBrnd: AllowedPaymentBrand1? = null,
    ...
    val pmtTp: CardAcquisitionRequest1.PmtTp? = null,
    val saleToAcqrrData: SaleToAcquirerData1? = null,
    val saleToIssrData: SaleToIssuerData1? = null,
    val saleToPOIData: SaleToPOIData3? = null,
    val saleTxId: SaleTransactionIdentification2? = null,
    val ttlAmt: TotalAmount13? = null
)
{
    /**
    * Type of payment transaction. PaymentType\\n\\n- ***CRDP*** : **CardPayment** Definition: Card payment.  \\n\\n- ***CSHW*** : **CashAdvance** Definition: Cash advance or withdrawals on a POI (Point Of Interaction), or at a bank counter.  \\n\\n- ***CSHD*** : **CashDeposit** Definition: Cash deposit.  \\n\\n- ***IRES*** : **InitialReservation** Definition: Initial reservation.  \\n\\n- ***DEFR*** : **DeferredPayment** Definition: Deferred payment.  \\n\\n- ***URES*** : **UpdateReservation** Definition: Update reservation.  \\n\\n- ***PRES*** : **PaymentReservation** Definition: Payment after reservation.  \\n\\n- ***RECP*** : **RecurringPayment** Definition: Recurring payment.  \\n\\n- ***INSP*** : **Instalment** Definition: Instalment payment.  \\n\\n- ***INSI*** : **IssuerInstalment** Definition: Instalment payment transaction performed by the card issuer.  \\n\\n- ***RFND*** : **Refund** Definition: Refund transaction.  \\n\\n- ***VCAU*** : **VoiceAuthorisation** Definition: Voice authorisation.  
