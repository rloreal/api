...
import com.lorealconsulting.nexoretail.kotlin.models.AccountNumber1
import com.lorealconsulting.nexoretail.kotlin.models.BankIdentification1
import com.lorealconsulting.nexoretail.kotlin.models.CheckCardNumber1
import com.lorealconsulting.nexoretail.kotlin.models.CheckNumber1
import com.lorealconsulting.nexoretail.kotlin.models.CheckTrackData21
import com.lorealconsulting.nexoretail.kotlin.models.Country3
...
data class Check1(
    ...
    val acctNb: AccountNumber1? = null,
    val bkId: BankIdentification1? = null,
    val chckCardNb: CheckCardNumber1? = null,
    val chckNb: CheckNumber1? = null,
    /* Type of the check (personal or professional). CheckType\\n\\n- ***BANK*** : **BankCheck** Definition: The check is guaranteed by a bank.  \\n\\n- ***BUSI*** : **BusinessCheck** Definition: The check belongs to a Company or a professional entity.  \\n\\n- ***GOVC*** : **GovernmentCheck** Definition: Check issued by Government.  \\n\\n- ***PAYR*** : **PayrollCheck** Definition: Check issued by a company for the employees.  \\n\\n- ***PERS*** : **PersonalCheck** Definition: The check belongs to an individual.   */
    val chckTp: Check1.ChckTp? = null,
    val chckTrckData2: CheckTrackData21? = null,
    val ctry: Country3? = null
)
{
    /**
    * Type of the check (personal or professional). CheckType\\n\\n- ***BANK*** : **BankCheck** Definition: The check is guaranteed by a bank.  \\n\\n- ***BUSI*** : **BusinessCheck** Definition: The check belongs to a Company or a professional entity.  \\n\\n- ***GOVC*** : **GovernmentCheck** Definition: Check issued by Government.  \\n\\n- ***PAYR*** : **PayrollCheck** Definition: Check issued by a company for the employees.  \\n\\n- ***PERS*** : **PersonalCheck** Definition: The check belongs to an individual.  
