...
/**
 * Identifier of the reconciliation between the Sale system and the POI system. SaleReconciliationIdentification
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class SaleReconciliationIdentification1(
