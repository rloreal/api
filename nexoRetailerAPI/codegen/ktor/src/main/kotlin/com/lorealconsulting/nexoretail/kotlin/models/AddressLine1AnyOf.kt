...
/**
 * Information that locates and identifies a specific address, as defined by postal services, presented in free format text. AddressLine
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class AddressLine1AnyOf(
