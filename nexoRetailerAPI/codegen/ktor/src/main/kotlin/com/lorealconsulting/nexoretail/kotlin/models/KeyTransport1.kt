...
import com.lorealconsulting.nexoretail.kotlin.models.KeyEncryptionAlgorithm3
import com.lorealconsulting.nexoretail.kotlin.models.RecipientIdentification1

import kotlinx.serialization.Serializable
/**
 * Encryption key using previously distributed asymmetric public key. KeyTransport
 * @param keyNcrptnAlgo 
 * @param ncrptdKey Encrypted key encryption key (KEK). EncryptedKey
 * @param rcptId 
 * @param atId 
 * @param vrsn Version of the data structure. Version
 */
@Serializable
data class KeyTransport1(
    val keyNcrptnAlgo: KeyEncryptionAlgorithm3,
    /* Encrypted key encryption key (KEK). EncryptedKey */
    val ncrptdKey: kotlin.String,
    val rcptId: RecipientIdentification1,
    /*  */
    val atId: kotlin.String? = null,
    /* Version of the data structure. Version */
