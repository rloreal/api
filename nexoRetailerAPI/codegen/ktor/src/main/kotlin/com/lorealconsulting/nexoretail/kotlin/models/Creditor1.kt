...
import com.lorealconsulting.nexoretail.kotlin.models.NameAndAddress1
import com.lorealconsulting.nexoretail.kotlin.models.ProprietaryIdentification1

import kotlinx.serialization.Serializable
/**
 * Party that receives an amount of money from the debtor. In the context of the payment model, the creditor is also the credit account owner. Creditor
 * @param atId 
 * @param anyBIC Unique and unambiguous identifier for an organisation that is allocated by an institution, for example, Dun & Bradstreet Identification. AnyBIC
 * @param nmAndAdr 
 * @param prtryId 
 */
@Serializable
data class Creditor1(
    /*  */
    val atId: kotlin.String? = null,
    /* Unique and unambiguous identifier for an organisation that is allocated by an institution, for example, Dun & Bradstreet Identification. AnyBIC */
    val anyBIC: kotlin.String? = null,
    val nmAndAdr: NameAndAddress1? = null,
    val prtryId: ProprietaryIdentification1? = null
)
{
}
