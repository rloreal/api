 ...
 * @param detail A granular description on the specific error related to a body property, query parameter, path parameters, and/or header.
 * @param pointer A JSON Pointer to a specific request body property that is the source of error.
 * @param parameter The name of the query or path parameter that is the source of error.
 * @param header The name of the header that is the source of error.
 * @param code A string containing additional provider specific codes to identify the error context.
 */
@Serializable
data class CreateFinancialService400ResponseErrorsInner(
