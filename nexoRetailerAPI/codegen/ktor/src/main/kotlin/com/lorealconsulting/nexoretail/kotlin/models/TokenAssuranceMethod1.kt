...
/**
 * Value that allows a Token Service Provider to indicate the identification and verification performed representing the binding of the payment token to the underlying PAN and cardholder. TokenAssuranceMethod
 * @param `value` 
 * @param atLang 
 */
@Serializable
data class TokenAssuranceMethod1(
