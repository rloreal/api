...
import com.lorealconsulting.nexoretail.kotlin.models.IndividualPayment1

import kotlinx.serialization.Serializable
/**
 * Payment transaction with an aggregated amount. AggregationTransaction
 * @param atId 
 * @param frstPmtDtTm Date and time of the first payment. FirstPaymentDateTime
 * @param indvPmt 
 * @param lastPmtDtTm Date and time of the last payment. LastPaymentDateTime
 * @param nbOfPmts Total number of payments that has been aggregated. NumberOfPayments
 */
@Serializable
data class AggregationTransaction1(
    /*  */
    val atId: kotlin.String? = null,
    /* Date and time of the first payment. FirstPaymentDateTime */
    val frstPmtDtTm: kotlin.String? = null,
    val indvPmt: IndividualPayment1? = null,
    /* Date and time of the last payment. LastPaymentDateTime */
    val lastPmtDtTm: kotlin.String? = null,
    /* Total number of payments that has been aggregated. NumberOfPayments */
    val nbOfPmts: java.math.BigDecimal? = null
)
{
}
