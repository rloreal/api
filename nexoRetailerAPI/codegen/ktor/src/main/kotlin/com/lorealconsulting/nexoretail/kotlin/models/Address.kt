...
import com.lorealconsulting.nexoretail.kotlin.models.AddressAnyOf
import com.lorealconsulting.nexoretail.kotlin.models.AddressValue
...
@Serializable
data class Address(
    val adrVal: AddressValue,
    /* Type of communication network. NetworkType\\n\\n- ***IPNW*** : **InternetProtocol** Definition: Protocol of an IP network.  \\n\\n- ***PSTN*** : **PublicTelephone** Definition: Protocol of a Public Switched Telephone Network (PSTN).   */
    val ntwkTp: Address.NtwkTp,
    /*  */
