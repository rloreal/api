...
import com.lorealconsulting.nexoretail.kotlin.models.Header2
import com.lorealconsulting.nexoretail.kotlin.models.SecurityTrailer2
import com.lorealconsulting.nexoretail.kotlin.models.ServiceResponse1
 ...
 */
@Serializable
data class ServiceInformation200Response(
    val hdr: Header2,
    val svcRspn: ServiceResponse1,
    /*  */
    val atMinorVersion: kotlin.collections.List<kotlin.String>? = null,
    val sctyTrlr: SecurityTrailer2? = null
)
{
}
